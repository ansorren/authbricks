...
const (
	...
	TypeAuthorizationEndpointConfig = "AuthorizationEndpointConfig"
	TypeAuthorizationPayload        = "AuthorizationPayload"
	TypeConnectionConfig            = "ConnectionConfig"
	TypeCookieStore                 = "CookieStore"
	TypeCredentials                 = "Credentials"
	TypeEmailPasswordConnection     = "EmailPasswordConnection"
	TypeIntrospectionEndpointConfig = "IntrospectionEndpointConfig"
	TypeJwksEndpointConfig          = "JwksEndpointConfig"
	TypeKeySet                      = "KeySet"
	TypeLoginEndpointConfig         = "LoginEndpointConfig"
	TypeOIDCConnection              = "OIDCConnection"
	TypeRefreshToken                = "RefreshToken"
	TypeService                     = "Service"
	TypeSession                     = "Session"
	TypeSigningKey                  = "SigningKey"
	TypeStandardClaims              = "StandardClaims"
	TypeTokenEndpointConfig         = "TokenEndpointConfig"
	TypeUser                        = "User"
	TypeUserInfoEndpointConfig      = "UserInfoEndpointConfig"
...
// AuthorizationEndpointConfigMutation represents an operation that mutates the AuthorizationEndpointConfig nodes in the graph.
type AuthorizationEndpointConfigMutation struct {
	config
	op                                       Op
	typ                                      string
	id                                       *string
	...
	oldValue                                 func(context.Context) (*AuthorizationEndpointConfig, error)
	predicates                               []predicate.AuthorizationEndpointConfig
}

var _ ent.Mutation = (*AuthorizationEndpointConfigMutation)(nil)

// authorizationendpointconfigOption allows management of the mutation configuration using functional options.
type authorizationendpointconfigOption func(*AuthorizationEndpointConfigMutation)

// newAuthorizationEndpointConfigMutation creates new mutation for the AuthorizationEndpointConfig entity.
func newAuthorizationEndpointConfigMutation(c config, op Op, opts ...authorizationendpointconfigOption) *AuthorizationEndpointConfigMutation {
	m := &AuthorizationEndpointConfigMutation{
		config:        c,
		op:            op,
		typ:           TypeAuthorizationEndpointConfig,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withAuthorizationEndpointConfigID sets the ID field of the mutation.
func withAuthorizationEndpointConfigID(id string) authorizationendpointconfigOption {
	return func(m *AuthorizationEndpointConfigMutation) {
		var (
			err   error
			once  sync.Once
			value *AuthorizationEndpointConfig
		)
		m.oldValue = func(ctx context.Context) (*AuthorizationEndpointConfig, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().AuthorizationEndpointConfig.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withAuthorizationEndpointConfig sets the old AuthorizationEndpointConfig of the mutation.
func withAuthorizationEndpointConfig(node *AuthorizationEndpointConfig) authorizationendpointconfigOption {
	return func(m *AuthorizationEndpointConfigMutation) {
		m.oldValue = func(context.Context) (*AuthorizationEndpointConfig, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m AuthorizationEndpointConfigMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m AuthorizationEndpointConfigMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of AuthorizationEndpointConfig entities.
func (m *AuthorizationEndpointConfigMutation) SetID(id string) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *AuthorizationEndpointConfigMutation) ID() (id string, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *AuthorizationEndpointConfigMutation) IDs(ctx context.Context) ([]string, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().AuthorizationEndpointConfig.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
func (m *AuthorizationEndpointConfigMutation) SetEndpoint(s string) {
	m.endpoint = &s
}

// Endpoint returns the value of the "endpoint" field in the mutation.
func (m *AuthorizationEndpointConfigMutation) Endpoint() (r string, exists bool) {
	v := m.endpoint
	if v == nil {
		return
	}
...
// OldEndpoint returns the old "endpoint" field's value of the AuthorizationEndpointConfig entity.
// If the AuthorizationEndpointConfig object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AuthorizationEndpointConfigMutation) OldEndpoint(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AuthorizationEndpointConfigMutation) ResetEndpoint() {
	m.endpoint = nil
}

// SetPkceRequired sets the "pkce_required" field.
func (m *AuthorizationEndpointConfigMutation) SetPkceRequired(b bool) {
	m.pkce_required = &b
}

// PkceRequired returns the value of the "pkce_required" field in the mutation.
func (m *AuthorizationEndpointConfigMutation) PkceRequired() (r bool, exists bool) {
	v := m.pkce_required
	if v == nil {
		return
	}
...
// OldPkceRequired returns the old "pkce_required" field's value of the AuthorizationEndpointConfig entity.
// If the AuthorizationEndpointConfig object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AuthorizationEndpointConfigMutation) OldPkceRequired(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldPkceRequired is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetPkceRequired resets all changes to the "pkce_required" field.
func (m *AuthorizationEndpointConfigMutation) ResetPkceRequired() {
	m.pkce_required = nil
}

// SetPkceS256CodeChallengeMethodRequired sets the "pkce_s256_code_challenge_method_required" field.
func (m *AuthorizationEndpointConfigMutation) SetPkceS256CodeChallengeMethodRequired(b bool) {
...
func (m *AuthorizationEndpointConfigMutation) PkceS256CodeChallengeMethodRequired() (r bool, exists bool) {
...
// OldPkceS256CodeChallengeMethodRequired returns the old "pkce_s256_code_challenge_method_required" field's value of the AuthorizationEndpointConfig entity.
// If the AuthorizationEndpointConfig object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AuthorizationEndpointConfigMutation) OldPkceS256CodeChallengeMethodRequired(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AuthorizationEndpointConfigMutation) ResetPkceS256CodeChallengeMethodRequired() {
	m.pkce_s256_code_challenge_method_required = nil
}

// SetServiceID sets the "service" edge to the Service entity by id.
func (m *AuthorizationEndpointConfigMutation) SetServiceID(id string) {
	m.service = &id
}

// ClearService clears the "service" edge to the Service entity.
func (m *AuthorizationEndpointConfigMutation) ClearService() {
	m.clearedservice = true
}

// ServiceCleared reports if the "service" edge to the Service entity was cleared.
func (m *AuthorizationEndpointConfigMutation) ServiceCleared() bool {
	return m.clearedservice
}

// ServiceID returns the "service" edge ID in the mutation.
func (m *AuthorizationEndpointConfigMutation) ServiceID() (id string, exists bool) {
	if m.service != nil {
		return *m.service, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ServiceID instead. It exists only for internal usage by the builders.
func (m *AuthorizationEndpointConfigMutation) ServiceIDs() (ids []string) {
	if id := m.service; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetService resets all changes to the "service" edge.
func (m *AuthorizationEndpointConfigMutation) ResetService() {
	m.service = nil
	m.clearedservice = false
}

// Where appends a list predicates to the AuthorizationEndpointConfigMutation builder.
func (m *AuthorizationEndpointConfigMutation) Where(ps ...predicate.AuthorizationEndpointConfig) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the AuthorizationEndpointConfigMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *AuthorizationEndpointConfigMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.AuthorizationEndpointConfig, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *AuthorizationEndpointConfigMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *AuthorizationEndpointConfigMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (AuthorizationEndpointConfig).
func (m *AuthorizationEndpointConfigMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *AuthorizationEndpointConfigMutation) Fields() []string {
	fields := make([]string, 0, 3)
	if m.endpoint != nil {
		fields = append(fields, authorizationendpointconfig.FieldEndpoint)
	}
	if m.pkce_required != nil {
		fields = append(fields, authorizationendpointconfig.FieldPkceRequired)
	}
	if m.pkce_s256_code_challenge_method_required != nil {
		fields = append(fields, authorizationendpointconfig.FieldPkceS256CodeChallengeMethodRequired)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *AuthorizationEndpointConfigMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *AuthorizationEndpointConfigMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case authorizationendpointconfig.FieldEndpoint:
	...
	return nil, fmt.Errorf("unknown AuthorizationEndpointConfig field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *AuthorizationEndpointConfigMutation) SetField(name string, value ent.Value) error {
	switch name {
	case authorizationendpointconfig.FieldEndpoint:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown AuthorizationEndpointConfig field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *AuthorizationEndpointConfigMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *AuthorizationEndpointConfigMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *AuthorizationEndpointConfigMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown AuthorizationEndpointConfig numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *AuthorizationEndpointConfigMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *AuthorizationEndpointConfigMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *AuthorizationEndpointConfigMutation) ClearField(name string) error {
	return fmt.Errorf("unknown AuthorizationEndpointConfig nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *AuthorizationEndpointConfigMutation) ResetField(name string) error {
	switch name {
	case authorizationendpointconfig.FieldEndpoint:
		m.ResetEndpoint()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *AuthorizationEndpointConfigMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.service != nil {
		edges = append(edges, authorizationendpointconfig.EdgeService)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *AuthorizationEndpointConfigMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case authorizationendpointconfig.EdgeService:
		if id := m.service; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *AuthorizationEndpointConfigMutation) RemovedEdges() []string {
	edges := make([]string, 0, 1)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *AuthorizationEndpointConfigMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *AuthorizationEndpointConfigMutation) ClearedEdges() []string {
	edges := make([]string, 0, 1)
	if m.clearedservice {
		edges = append(edges, authorizationendpointconfig.EdgeService)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *AuthorizationEndpointConfigMutation) EdgeCleared(name string) bool {
	switch name {
	case authorizationendpointconfig.EdgeService:
		return m.clearedservice
	}
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *AuthorizationEndpointConfigMutation) ClearEdge(name string) error {
	switch name {
	case authorizationendpointconfig.EdgeService:
		m.ClearService()
		return nil
	}
	return fmt.Errorf("unknown AuthorizationEndpointConfig unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *AuthorizationEndpointConfigMutation) ResetEdge(name string) error {
	switch name {
	case authorizationendpointconfig.EdgeService:
		m.ResetService()
		return nil
	}
	return fmt.Errorf("unknown AuthorizationEndpointConfig edge %s", name)
}
...
func (m *AuthorizationPayloadMutation) SetServiceName(s string) {
	m.service_name = &s
}

// ServiceName returns the value of the "service_name" field in the mutation.
func (m *AuthorizationPayloadMutation) ServiceName() (r string, exists bool) {
	v := m.service_name
	if v == nil {
		return
	}
...
// OldServiceName returns the old "service_name" field's value of the AuthorizationPayload entity.
// If the AuthorizationPayload object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AuthorizationPayloadMutation) OldServiceName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *AuthorizationPayloadMutation) ResetServiceName() {
	m.service_name = nil
}
...
func (m *AuthorizationPayloadMutation) Fields() []string {
	...
	if m.service_name != nil {
		fields = append(fields, authorizationpayload.FieldServiceName)
	}
	if m.state != nil {
...
// ConnectionConfigMutation represents an operation that mutates the ConnectionConfig nodes in the graph.
type ConnectionConfigMutation struct {
	config
	op                               Op
	typ                              string
	id                               *string
	...
	service                          *string
	clearedservice                   bool
	oidc_connections                 map[string]struct{}
	removedoidc_connections          map[string]struct{}
	clearedoidc_connections          bool
	email_password_connection        *string
	clearedemail_password_connection bool
	done                             bool
	oldValue                         func(context.Context) (*ConnectionConfig, error)
	predicates                       []predicate.ConnectionConfig
}

var _ ent.Mutation = (*ConnectionConfigMutation)(nil)

// connectionconfigOption allows management of the mutation configuration using functional options.
type connectionconfigOption func(*ConnectionConfigMutation)

// newConnectionConfigMutation creates new mutation for the ConnectionConfig entity.
func newConnectionConfigMutation(c config, op Op, opts ...connectionconfigOption) *ConnectionConfigMutation {
	m := &ConnectionConfigMutation{
		config:        c,
		op:            op,
		typ:           TypeConnectionConfig,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withConnectionConfigID sets the ID field of the mutation.
func withConnectionConfigID(id string) connectionconfigOption {
	return func(m *ConnectionConfigMutation) {
		var (
			err   error
			once  sync.Once
			value *ConnectionConfig
		)
		m.oldValue = func(ctx context.Context) (*ConnectionConfig, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().ConnectionConfig.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withConnectionConfig sets the old ConnectionConfig of the mutation.
func withConnectionConfig(node *ConnectionConfig) connectionconfigOption {
	return func(m *ConnectionConfigMutation) {
		m.oldValue = func(context.Context) (*ConnectionConfig, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m ConnectionConfigMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m ConnectionConfigMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of ConnectionConfig entities.
func (m *ConnectionConfigMutation) SetID(id string) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *ConnectionConfigMutation) ID() (id string, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *ConnectionConfigMutation) IDs(ctx context.Context) ([]string, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().ConnectionConfig.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetServiceID sets the "service" edge to the Service entity by id.
func (m *ConnectionConfigMutation) SetServiceID(id string) {
	m.service = &id
}

// ClearService clears the "service" edge to the Service entity.
func (m *ConnectionConfigMutation) ClearService() {
	m.clearedservice = true
}

// ServiceCleared reports if the "service" edge to the Service entity was cleared.
func (m *ConnectionConfigMutation) ServiceCleared() bool {
	return m.clearedservice
}

// ServiceID returns the "service" edge ID in the mutation.
func (m *ConnectionConfigMutation) ServiceID() (id string, exists bool) {
	if m.service != nil {
		return *m.service, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ServiceID instead. It exists only for internal usage by the builders.
func (m *ConnectionConfigMutation) ServiceIDs() (ids []string) {
	if id := m.service; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetService resets all changes to the "service" edge.
func (m *ConnectionConfigMutation) ResetService() {
	m.service = nil
	m.clearedservice = false
}

// AddOidcConnectionIDs adds the "oidc_connections" edge to the OIDCConnection entity by ids.
func (m *ConnectionConfigMutation) AddOidcConnectionIDs(ids ...string) {
	if m.oidc_connections == nil {
		m.oidc_connections = make(map[string]struct{})
	}
	for i := range ids {
		m.oidc_connections[ids[i]] = struct{}{}
	}
}

// ClearOidcConnections clears the "oidc_connections" edge to the OIDCConnection entity.
func (m *ConnectionConfigMutation) ClearOidcConnections() {
	m.clearedoidc_connections = true
}

// OidcConnectionsCleared reports if the "oidc_connections" edge to the OIDCConnection entity was cleared.
func (m *ConnectionConfigMutation) OidcConnectionsCleared() bool {
	return m.clearedoidc_connections
}

// RemoveOidcConnectionIDs removes the "oidc_connections" edge to the OIDCConnection entity by IDs.
func (m *ConnectionConfigMutation) RemoveOidcConnectionIDs(ids ...string) {
	if m.removedoidc_connections == nil {
		m.removedoidc_connections = make(map[string]struct{})
	}
	for i := range ids {
		delete(m.oidc_connections, ids[i])
		m.removedoidc_connections[ids[i]] = struct{}{}
	}
}

// RemovedOidcConnections returns the removed IDs of the "oidc_connections" edge to the OIDCConnection entity.
func (m *ConnectionConfigMutation) RemovedOidcConnectionsIDs() (ids []string) {
	for id := range m.removedoidc_connections {
		ids = append(ids, id)
	}
	return
}

// OidcConnectionsIDs returns the "oidc_connections" edge IDs in the mutation.
func (m *ConnectionConfigMutation) OidcConnectionsIDs() (ids []string) {
	for id := range m.oidc_connections {
		ids = append(ids, id)
	}
	return
}

// ResetOidcConnections resets all changes to the "oidc_connections" edge.
func (m *ConnectionConfigMutation) ResetOidcConnections() {
	m.oidc_connections = nil
	m.clearedoidc_connections = false
	m.removedoidc_connections = nil
}

// SetEmailPasswordConnectionID sets the "email_password_connection" edge to the EmailPasswordConnection entity by id.
func (m *ConnectionConfigMutation) SetEmailPasswordConnectionID(id string) {
	m.email_password_connection = &id
}

// ClearEmailPasswordConnection clears the "email_password_connection" edge to the EmailPasswordConnection entity.
func (m *ConnectionConfigMutation) ClearEmailPasswordConnection() {
	m.clearedemail_password_connection = true
}

// EmailPasswordConnectionCleared reports if the "email_password_connection" edge to the EmailPasswordConnection entity was cleared.
func (m *ConnectionConfigMutation) EmailPasswordConnectionCleared() bool {
	return m.clearedemail_password_connection
}

// EmailPasswordConnectionID returns the "email_password_connection" edge ID in the mutation.
func (m *ConnectionConfigMutation) EmailPasswordConnectionID() (id string, exists bool) {
	if m.email_password_connection != nil {
		return *m.email_password_connection, true
	}
	return
}

// EmailPasswordConnectionIDs returns the "email_password_connection" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// EmailPasswordConnectionID instead. It exists only for internal usage by the builders.
func (m *ConnectionConfigMutation) EmailPasswordConnectionIDs() (ids []string) {
	if id := m.email_password_connection; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetEmailPasswordConnection resets all changes to the "email_password_connection" edge.
func (m *ConnectionConfigMutation) ResetEmailPasswordConnection() {
	m.email_password_connection = nil
	m.clearedemail_password_connection = false
}

// Where appends a list predicates to the ConnectionConfigMutation builder.
func (m *ConnectionConfigMutation) Where(ps ...predicate.ConnectionConfig) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the ConnectionConfigMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *ConnectionConfigMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.ConnectionConfig, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *ConnectionConfigMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *ConnectionConfigMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (ConnectionConfig).
func (m *ConnectionConfigMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *ConnectionConfigMutation) Fields() []string {
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *ConnectionConfigMutation) Field(name string) (ent.Value, bool) {
	return nil, false
}
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *ConnectionConfigMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	return nil, fmt.Errorf("unknown ConnectionConfig field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ConnectionConfigMutation) SetField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown ConnectionConfig field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *ConnectionConfigMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *ConnectionConfigMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *ConnectionConfigMutation) AddField(name string, value ent.Value) error {
	return fmt.Errorf("unknown ConnectionConfig numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *ConnectionConfigMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *ConnectionConfigMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *ConnectionConfigMutation) ClearField(name string) error {
	return fmt.Errorf("unknown ConnectionConfig nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *ConnectionConfigMutation) ResetField(name string) error {
	return fmt.Errorf("unknown ConnectionConfig field %s", name)
}

// AddedEdges returns all edge names that were set/added in this mutation.
func (m *ConnectionConfigMutation) AddedEdges() []string {
	edges := make([]string, 0, 3)
	if m.service != nil {
		edges = append(edges, connectionconfig.EdgeService)
	}
	if m.oidc_connections != nil {
		edges = append(edges, connectionconfig.EdgeOidcConnections)
	}
	if m.email_password_connection != nil {
		edges = append(edges, connectionconfig.EdgeEmailPasswordConnection)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *ConnectionConfigMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case connectionconfig.EdgeService:
		if id := m.service; id != nil {
			return []ent.Value{*id}
		}
	case connectionconfig.EdgeOidcConnections:
		ids := make([]ent.Value, 0, len(m.oidc_connections))
		for id := range m.oidc_connections {
			ids = append(ids, id)
		}
		return ids
	case connectionconfig.EdgeEmailPasswordConnection:
		if id := m.email_password_connection; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *ConnectionConfigMutation) RemovedEdges() []string {
	edges := make([]string, 0, 3)
	if m.removedoidc_connections != nil {
		edges = append(edges, connectionconfig.EdgeOidcConnections)
	}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *ConnectionConfigMutation) RemovedIDs(name string) []ent.Value {
	switch name {
	case connectionconfig.EdgeOidcConnections:
		ids := make([]ent.Value, 0, len(m.removedoidc_connections))
		for id := range m.removedoidc_connections {
			ids = append(ids, id)
		}
		return ids
...
// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *ConnectionConfigMutation) ClearedEdges() []string {
	edges := make([]string, 0, 3)
	if m.clearedservice {
		edges = append(edges, connectionconfig.EdgeService)
	}
	if m.clearedoidc_connections {
		edges = append(edges, connectionconfig.EdgeOidcConnections)
	}
	if m.clearedemail_password_connection {
		edges = append(edges, connectionconfig.EdgeEmailPasswordConnection)
	}
	return edges
}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *ConnectionConfigMutation) EdgeCleared(name string) bool {
	switch name {
	case connectionconfig.EdgeService:
		return m.clearedservice
	case connectionconfig.EdgeOidcConnections:
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *ConnectionConfigMutation) ClearEdge(name string) error {
	switch name {
	case connectionconfig.EdgeService:
		m.ClearService()
		return nil
	case connectionconfig.EdgeEmailPasswordConnection:
		m.ClearEmailPasswordConnection()
		return nil
	}
	return fmt.Errorf("unknown ConnectionConfig unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *ConnectionConfigMutation) ResetEdge(name string) error {
	switch name {
	case connectionconfig.EdgeService:
		m.ResetService()
		return nil
	case connectionconfig.EdgeOidcConnections:
		m.ResetOidcConnections()
		return nil
	case connectionconfig.EdgeEmailPasswordConnection:
		m.ResetEmailPasswordConnection()
		return nil
	}
	return fmt.Errorf("unknown ConnectionConfig edge %s", name)
}
...
// EmailPasswordConnectionMutation represents an operation that mutates the EmailPasswordConnection nodes in the graph.
type EmailPasswordConnectionMutation struct {
	config
	op                       Op
	typ                      string
	id                       *string
	...
	clearedconnection_config bool
	users                    *string
	clearedusers             bool
	done                     bool
	oldValue                 func(context.Context) (*EmailPasswordConnection, error)
	predicates               []predicate.EmailPasswordConnection
}

var _ ent.Mutation = (*EmailPasswordConnectionMutation)(nil)

// emailpasswordconnectionOption allows management of the mutation configuration using functional options.
type emailpasswordconnectionOption func(*EmailPasswordConnectionMutation)

// newEmailPasswordConnectionMutation creates new mutation for the EmailPasswordConnection entity.
func newEmailPasswordConnectionMutation(c config, op Op, opts ...emailpasswordconnectionOption) *EmailPasswordConnectionMutation {
	m := &EmailPasswordConnectionMutation{
		config:        c,
		op:            op,
		typ:           TypeEmailPasswordConnection,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withEmailPasswordConnectionID sets the ID field of the mutation.
func withEmailPasswordConnectionID(id string) emailpasswordconnectionOption {
	return func(m *EmailPasswordConnectionMutation) {
		var (
			err   error
			once  sync.Once
			value *EmailPasswordConnection
		)
		m.oldValue = func(ctx context.Context) (*EmailPasswordConnection, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().EmailPasswordConnection.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withEmailPasswordConnection sets the old EmailPasswordConnection of the mutation.
func withEmailPasswordConnection(node *EmailPasswordConnection) emailpasswordconnectionOption {
	return func(m *EmailPasswordConnectionMutation) {
		m.oldValue = func(context.Context) (*EmailPasswordConnection, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m EmailPasswordConnectionMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m EmailPasswordConnectionMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of EmailPasswordConnection entities.
func (m *EmailPasswordConnectionMutation) SetID(id string) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *EmailPasswordConnectionMutation) ID() (id string, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *EmailPasswordConnectionMutation) IDs(ctx context.Context) ([]string, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().EmailPasswordConnection.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
func (m *EmailPasswordConnectionMutation) SetEnabled(b bool) {
	m.enabled = &b
}

// Enabled returns the value of the "enabled" field in the mutation.
func (m *EmailPasswordConnectionMutation) Enabled() (r bool, exists bool) {
	v := m.enabled
	if v == nil {
		return
	}
...
// OldEnabled returns the old "enabled" field's value of the EmailPasswordConnection entity.
// If the EmailPasswordConnection object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *EmailPasswordConnectionMutation) OldEnabled(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *EmailPasswordConnectionMutation) ResetEnabled() {
	m.enabled = nil
}

// SetConnectionConfigID sets the "connection_config" edge to the ConnectionConfig entity by id.
func (m *EmailPasswordConnectionMutation) SetConnectionConfigID(id string) {
	m.connection_config = &id
}

// ClearConnectionConfig clears the "connection_config" edge to the ConnectionConfig entity.
func (m *EmailPasswordConnectionMutation) ClearConnectionConfig() {
	m.clearedconnection_config = true
}

// ConnectionConfigCleared reports if the "connection_config" edge to the ConnectionConfig entity was cleared.
func (m *EmailPasswordConnectionMutation) ConnectionConfigCleared() bool {
	return m.clearedconnection_config
}

// ConnectionConfigID returns the "connection_config" edge ID in the mutation.
func (m *EmailPasswordConnectionMutation) ConnectionConfigID() (id string, exists bool) {
	if m.connection_config != nil {
		return *m.connection_config, true
	}
	return
}

// ConnectionConfigIDs returns the "connection_config" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ConnectionConfigID instead. It exists only for internal usage by the builders.
func (m *EmailPasswordConnectionMutation) ConnectionConfigIDs() (ids []string) {
	if id := m.connection_config; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetConnectionConfig resets all changes to the "connection_config" edge.
func (m *EmailPasswordConnectionMutation) ResetConnectionConfig() {
	m.connection_config = nil
	m.clearedconnection_config = false
}

// SetUsersID sets the "users" edge to the User entity by id.
func (m *EmailPasswordConnectionMutation) SetUsersID(id string) {
	m.users = &id
}

// ClearUsers clears the "users" edge to the User entity.
func (m *EmailPasswordConnectionMutation) ClearUsers() {
	m.clearedusers = true
}

// UsersCleared reports if the "users" edge to the User entity was cleared.
func (m *EmailPasswordConnectionMutation) UsersCleared() bool {
	return m.clearedusers
}

// UsersID returns the "users" edge ID in the mutation.
func (m *EmailPasswordConnectionMutation) UsersID() (id string, exists bool) {
	if m.users != nil {
		return *m.users, true
	}
	return
...
func (m *EmailPasswordConnectionMutation) UsersIDs() (ids []string) {
...
func (m *EmailPasswordConnectionMutation) ResetUsers() {
	m.users = nil
	m.clearedusers = false
}

// Where appends a list predicates to the EmailPasswordConnectionMutation builder.
func (m *EmailPasswordConnectionMutation) Where(ps ...predicate.EmailPasswordConnection) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the EmailPasswordConnectionMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *EmailPasswordConnectionMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.EmailPasswordConnection, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *EmailPasswordConnectionMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *EmailPasswordConnectionMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (EmailPasswordConnection).
func (m *EmailPasswordConnectionMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *EmailPasswordConnectionMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m.enabled != nil {
		fields = append(fields, emailpasswordconnection.FieldEnabled)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *EmailPasswordConnectionMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *EmailPasswordConnectionMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case emailpasswordconnection.FieldEnabled:
		return m.OldEnabled(ctx)
	}
	return nil, fmt.Errorf("unknown EmailPasswordConnection field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *EmailPasswordConnectionMutation) SetField(name string, value ent.Value) error {
	switch name {
	case emailpasswordconnection.FieldEnabled:
		v, ok := value.(bool)
		if !ok {
	...
	return fmt.Errorf("unknown EmailPasswordConnection field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *EmailPasswordConnectionMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *EmailPasswordConnectionMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *EmailPasswordConnectionMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown EmailPasswordConnection numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *EmailPasswordConnectionMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *EmailPasswordConnectionMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *EmailPasswordConnectionMutation) ClearField(name string) error {
	return fmt.Errorf("unknown EmailPasswordConnection nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *EmailPasswordConnectionMutation) ResetField(name string) error {
	switch name {
	case emailpasswordconnection.FieldEnabled:
		m.ResetEnabled()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *EmailPasswordConnectionMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.connection_config != nil {
		edges = append(edges, emailpasswordconnection.EdgeConnectionConfig)
	}
	if m.users != nil {
		edges = append(edges, emailpasswordconnection.EdgeUsers)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *EmailPasswordConnectionMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case emailpasswordconnection.EdgeConnectionConfig:
		if id := m.connection_config; id != nil {
			return []ent.Value{*id}
		}
	case emailpasswordconnection.EdgeUsers:
		if id := m.users; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *EmailPasswordConnectionMutation) RemovedEdges() []string {
	edges := make([]string, 0, 2)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *EmailPasswordConnectionMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *EmailPasswordConnectionMutation) ClearedEdges() []string {
	edges := make([]string, 0, 2)
	if m.clearedconnection_config {
		edges = append(edges, emailpasswordconnection.EdgeConnectionConfig)
	}
	if m.clearedusers {
		edges = append(edges, emailpasswordconnection.EdgeUsers)
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *EmailPasswordConnectionMutation) EdgeCleared(name string) bool {
	switch name {
	case emailpasswordconnection.EdgeConnectionConfig:
		return m.clearedconnection_config
	case emailpasswordconnection.EdgeUsers:
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *EmailPasswordConnectionMutation) ClearEdge(name string) error {
	switch name {
	case emailpasswordconnection.EdgeConnectionConfig:
		m.ClearConnectionConfig()
		return nil
	case emailpasswordconnection.EdgeUsers:
		m.ClearUsers()
		return nil
	}
	return fmt.Errorf("unknown EmailPasswordConnection unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *EmailPasswordConnectionMutation) ResetEdge(name string) error {
	switch name {
	case emailpasswordconnection.EdgeConnectionConfig:
		m.ResetConnectionConfig()
		return nil
	case emailpasswordconnection.EdgeUsers:
		m.ResetUsers()
		return nil
	}
	return fmt.Errorf("unknown EmailPasswordConnection edge %s", name)
}

// IntrospectionEndpointConfigMutation represents an operation that mutates the IntrospectionEndpointConfig nodes in the graph.
type IntrospectionEndpointConfigMutation struct {
	config
	op             Op
	typ            string
	id             *string
	...
	oldValue       func(context.Context) (*IntrospectionEndpointConfig, error)
	predicates     []predicate.IntrospectionEndpointConfig
}

var _ ent.Mutation = (*IntrospectionEndpointConfigMutation)(nil)

// introspectionendpointconfigOption allows management of the mutation configuration using functional options.
type introspectionendpointconfigOption func(*IntrospectionEndpointConfigMutation)

// newIntrospectionEndpointConfigMutation creates new mutation for the IntrospectionEndpointConfig entity.
func newIntrospectionEndpointConfigMutation(c config, op Op, opts ...introspectionendpointconfigOption) *IntrospectionEndpointConfigMutation {
	m := &IntrospectionEndpointConfigMutation{
		config:        c,
		op:            op,
		typ:           TypeIntrospectionEndpointConfig,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withIntrospectionEndpointConfigID sets the ID field of the mutation.
func withIntrospectionEndpointConfigID(id string) introspectionendpointconfigOption {
	return func(m *IntrospectionEndpointConfigMutation) {
		var (
			err   error
			once  sync.Once
			value *IntrospectionEndpointConfig
		)
		m.oldValue = func(ctx context.Context) (*IntrospectionEndpointConfig, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().IntrospectionEndpointConfig.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withIntrospectionEndpointConfig sets the old IntrospectionEndpointConfig of the mutation.
func withIntrospectionEndpointConfig(node *IntrospectionEndpointConfig) introspectionendpointconfigOption {
	return func(m *IntrospectionEndpointConfigMutation) {
		m.oldValue = func(context.Context) (*IntrospectionEndpointConfig, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m IntrospectionEndpointConfigMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m IntrospectionEndpointConfigMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of IntrospectionEndpointConfig entities.
func (m *IntrospectionEndpointConfigMutation) SetID(id string) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *IntrospectionEndpointConfigMutation) ID() (id string, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *IntrospectionEndpointConfigMutation) IDs(ctx context.Context) ([]string, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().IntrospectionEndpointConfig.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetEndpoint sets the "endpoint" field.
func (m *IntrospectionEndpointConfigMutation) SetEndpoint(s string) {
	m.endpoint = &s
}

// Endpoint returns the value of the "endpoint" field in the mutation.
func (m *IntrospectionEndpointConfigMutation) Endpoint() (r string, exists bool) {
	v := m.endpoint
	if v == nil {
		return
	}
...
// OldEndpoint returns the old "endpoint" field's value of the IntrospectionEndpointConfig entity.
// If the IntrospectionEndpointConfig object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *IntrospectionEndpointConfigMutation) OldEndpoint(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldEndpoint is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetEndpoint resets all changes to the "endpoint" field.
func (m *IntrospectionEndpointConfigMutation) ResetEndpoint() {
	m.endpoint = nil
}

// SetServiceID sets the "service" edge to the Service entity by id.
func (m *IntrospectionEndpointConfigMutation) SetServiceID(id string) {
	m.service = &id
}

// ClearService clears the "service" edge to the Service entity.
func (m *IntrospectionEndpointConfigMutation) ClearService() {
	m.clearedservice = true
}

// ServiceCleared reports if the "service" edge to the Service entity was cleared.
func (m *IntrospectionEndpointConfigMutation) ServiceCleared() bool {
	return m.clearedservice
}

// ServiceID returns the "service" edge ID in the mutation.
func (m *IntrospectionEndpointConfigMutation) ServiceID() (id string, exists bool) {
	if m.service != nil {
		return *m.service, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ServiceID instead. It exists only for internal usage by the builders.
func (m *IntrospectionEndpointConfigMutation) ServiceIDs() (ids []string) {
	if id := m.service; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetService resets all changes to the "service" edge.
func (m *IntrospectionEndpointConfigMutation) ResetService() {
	m.service = nil
	m.clearedservice = false
}

// Where appends a list predicates to the IntrospectionEndpointConfigMutation builder.
func (m *IntrospectionEndpointConfigMutation) Where(ps ...predicate.IntrospectionEndpointConfig) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the IntrospectionEndpointConfigMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *IntrospectionEndpointConfigMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.IntrospectionEndpointConfig, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *IntrospectionEndpointConfigMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *IntrospectionEndpointConfigMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (IntrospectionEndpointConfig).
func (m *IntrospectionEndpointConfigMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *IntrospectionEndpointConfigMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m.endpoint != nil {
		fields = append(fields, introspectionendpointconfig.FieldEndpoint)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *IntrospectionEndpointConfigMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *IntrospectionEndpointConfigMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case introspectionendpointconfig.FieldEndpoint:
		return m.OldEndpoint(ctx)
	}
	return nil, fmt.Errorf("unknown IntrospectionEndpointConfig field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *IntrospectionEndpointConfigMutation) SetField(name string, value ent.Value) error {
	switch name {
	case introspectionendpointconfig.FieldEndpoint:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown IntrospectionEndpointConfig field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *IntrospectionEndpointConfigMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *IntrospectionEndpointConfigMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *IntrospectionEndpointConfigMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown IntrospectionEndpointConfig numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *IntrospectionEndpointConfigMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *IntrospectionEndpointConfigMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *IntrospectionEndpointConfigMutation) ClearField(name string) error {
	return fmt.Errorf("unknown IntrospectionEndpointConfig nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *IntrospectionEndpointConfigMutation) ResetField(name string) error {
	switch name {
	case introspectionendpointconfig.FieldEndpoint:
		m.ResetEndpoint()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *IntrospectionEndpointConfigMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.service != nil {
		edges = append(edges, introspectionendpointconfig.EdgeService)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *IntrospectionEndpointConfigMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case introspectionendpointconfig.EdgeService:
		if id := m.service; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *IntrospectionEndpointConfigMutation) RemovedEdges() []string {
	edges := make([]string, 0, 1)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *IntrospectionEndpointConfigMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *IntrospectionEndpointConfigMutation) ClearedEdges() []string {
	edges := make([]string, 0, 1)
	if m.clearedservice {
		edges = append(edges, introspectionendpointconfig.EdgeService)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *IntrospectionEndpointConfigMutation) EdgeCleared(name string) bool {
	switch name {
	case introspectionendpointconfig.EdgeService:
		return m.clearedservice
	}
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *IntrospectionEndpointConfigMutation) ClearEdge(name string) error {
	switch name {
	case introspectionendpointconfig.EdgeService:
		m.ClearService()
		return nil
	}
	return fmt.Errorf("unknown IntrospectionEndpointConfig unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *IntrospectionEndpointConfigMutation) ResetEdge(name string) error {
	switch name {
	case introspectionendpointconfig.EdgeService:
		m.ResetService()
		return nil
	}
	return fmt.Errorf("unknown IntrospectionEndpointConfig edge %s", name)
}

// JwksEndpointConfigMutation represents an operation that mutates the JwksEndpointConfig nodes in the graph.
type JwksEndpointConfigMutation struct {
	config
	op             Op
	typ            string
	id             *string
	...
	oldValue       func(context.Context) (*JwksEndpointConfig, error)
	predicates     []predicate.JwksEndpointConfig
}

var _ ent.Mutation = (*JwksEndpointConfigMutation)(nil)

// jwksendpointconfigOption allows management of the mutation configuration using functional options.
type jwksendpointconfigOption func(*JwksEndpointConfigMutation)

// newJwksEndpointConfigMutation creates new mutation for the JwksEndpointConfig entity.
func newJwksEndpointConfigMutation(c config, op Op, opts ...jwksendpointconfigOption) *JwksEndpointConfigMutation {
	m := &JwksEndpointConfigMutation{
		config:        c,
		op:            op,
		typ:           TypeJwksEndpointConfig,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withJwksEndpointConfigID sets the ID field of the mutation.
func withJwksEndpointConfigID(id string) jwksendpointconfigOption {
	return func(m *JwksEndpointConfigMutation) {
		var (
			err   error
			once  sync.Once
			value *JwksEndpointConfig
		)
		m.oldValue = func(ctx context.Context) (*JwksEndpointConfig, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().JwksEndpointConfig.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withJwksEndpointConfig sets the old JwksEndpointConfig of the mutation.
func withJwksEndpointConfig(node *JwksEndpointConfig) jwksendpointconfigOption {
	return func(m *JwksEndpointConfigMutation) {
		m.oldValue = func(context.Context) (*JwksEndpointConfig, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m JwksEndpointConfigMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m JwksEndpointConfigMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of JwksEndpointConfig entities.
func (m *JwksEndpointConfigMutation) SetID(id string) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *JwksEndpointConfigMutation) ID() (id string, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *JwksEndpointConfigMutation) IDs(ctx context.Context) ([]string, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().JwksEndpointConfig.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetEndpoint sets the "endpoint" field.
func (m *JwksEndpointConfigMutation) SetEndpoint(s string) {
	m.endpoint = &s
}

// Endpoint returns the value of the "endpoint" field in the mutation.
func (m *JwksEndpointConfigMutation) Endpoint() (r string, exists bool) {
	v := m.endpoint
	if v == nil {
		return
	}
...
// OldEndpoint returns the old "endpoint" field's value of the JwksEndpointConfig entity.
// If the JwksEndpointConfig object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *JwksEndpointConfigMutation) OldEndpoint(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldEndpoint is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetEndpoint resets all changes to the "endpoint" field.
func (m *JwksEndpointConfigMutation) ResetEndpoint() {
	m.endpoint = nil
}

// SetServiceID sets the "service" edge to the Service entity by id.
func (m *JwksEndpointConfigMutation) SetServiceID(id string) {
	m.service = &id
}

// ClearService clears the "service" edge to the Service entity.
func (m *JwksEndpointConfigMutation) ClearService() {
	m.clearedservice = true
}

// ServiceCleared reports if the "service" edge to the Service entity was cleared.
func (m *JwksEndpointConfigMutation) ServiceCleared() bool {
	return m.clearedservice
}

// ServiceID returns the "service" edge ID in the mutation.
func (m *JwksEndpointConfigMutation) ServiceID() (id string, exists bool) {
	if m.service != nil {
		return *m.service, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ServiceID instead. It exists only for internal usage by the builders.
func (m *JwksEndpointConfigMutation) ServiceIDs() (ids []string) {
	if id := m.service; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetService resets all changes to the "service" edge.
func (m *JwksEndpointConfigMutation) ResetService() {
	m.service = nil
	m.clearedservice = false
}

// Where appends a list predicates to the JwksEndpointConfigMutation builder.
func (m *JwksEndpointConfigMutation) Where(ps ...predicate.JwksEndpointConfig) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the JwksEndpointConfigMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *JwksEndpointConfigMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.JwksEndpointConfig, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *JwksEndpointConfigMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *JwksEndpointConfigMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (JwksEndpointConfig).
func (m *JwksEndpointConfigMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *JwksEndpointConfigMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m.endpoint != nil {
		fields = append(fields, jwksendpointconfig.FieldEndpoint)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *JwksEndpointConfigMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *JwksEndpointConfigMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case jwksendpointconfig.FieldEndpoint:
		return m.OldEndpoint(ctx)
	}
	return nil, fmt.Errorf("unknown JwksEndpointConfig field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *JwksEndpointConfigMutation) SetField(name string, value ent.Value) error {
	switch name {
	case jwksendpointconfig.FieldEndpoint:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown JwksEndpointConfig field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *JwksEndpointConfigMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *JwksEndpointConfigMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *JwksEndpointConfigMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown JwksEndpointConfig numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *JwksEndpointConfigMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *JwksEndpointConfigMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *JwksEndpointConfigMutation) ClearField(name string) error {
	return fmt.Errorf("unknown JwksEndpointConfig nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *JwksEndpointConfigMutation) ResetField(name string) error {
	switch name {
	case jwksendpointconfig.FieldEndpoint:
		m.ResetEndpoint()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *JwksEndpointConfigMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.service != nil {
		edges = append(edges, jwksendpointconfig.EdgeService)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *JwksEndpointConfigMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case jwksendpointconfig.EdgeService:
		if id := m.service; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *JwksEndpointConfigMutation) RemovedEdges() []string {
	edges := make([]string, 0, 1)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *JwksEndpointConfigMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *JwksEndpointConfigMutation) ClearedEdges() []string {
	edges := make([]string, 0, 1)
	if m.clearedservice {
		edges = append(edges, jwksendpointconfig.EdgeService)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *JwksEndpointConfigMutation) EdgeCleared(name string) bool {
	switch name {
	case jwksendpointconfig.EdgeService:
		return m.clearedservice
	}
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *JwksEndpointConfigMutation) ClearEdge(name string) error {
	switch name {
	case jwksendpointconfig.EdgeService:
		m.ClearService()
		return nil
	}
	return fmt.Errorf("unknown JwksEndpointConfig unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *JwksEndpointConfigMutation) ResetEdge(name string) error {
	switch name {
	case jwksendpointconfig.EdgeService:
		m.ResetService()
		return nil
	}
	return fmt.Errorf("unknown JwksEndpointConfig edge %s", name)
}
...
// LoginEndpointConfigMutation represents an operation that mutates the LoginEndpointConfig nodes in the graph.
type LoginEndpointConfigMutation struct {
	config
	op                 Op
	typ                string
	id                 *string
	...
	addsession_timeout *int64
	clearedFields      map[string]struct{}
	service            *string
	clearedservice     bool
	done               bool
	oldValue           func(context.Context) (*LoginEndpointConfig, error)
	predicates         []predicate.LoginEndpointConfig
}

var _ ent.Mutation = (*LoginEndpointConfigMutation)(nil)

// loginendpointconfigOption allows management of the mutation configuration using functional options.
type loginendpointconfigOption func(*LoginEndpointConfigMutation)

// newLoginEndpointConfigMutation creates new mutation for the LoginEndpointConfig entity.
func newLoginEndpointConfigMutation(c config, op Op, opts ...loginendpointconfigOption) *LoginEndpointConfigMutation {
	m := &LoginEndpointConfigMutation{
		config:        c,
		op:            op,
		typ:           TypeLoginEndpointConfig,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withLoginEndpointConfigID sets the ID field of the mutation.
func withLoginEndpointConfigID(id string) loginendpointconfigOption {
	return func(m *LoginEndpointConfigMutation) {
		var (
			err   error
			once  sync.Once
			value *LoginEndpointConfig
		)
		m.oldValue = func(ctx context.Context) (*LoginEndpointConfig, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().LoginEndpointConfig.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withLoginEndpointConfig sets the old LoginEndpointConfig of the mutation.
func withLoginEndpointConfig(node *LoginEndpointConfig) loginendpointconfigOption {
	return func(m *LoginEndpointConfigMutation) {
		m.oldValue = func(context.Context) (*LoginEndpointConfig, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m LoginEndpointConfigMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m LoginEndpointConfigMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of LoginEndpointConfig entities.
func (m *LoginEndpointConfigMutation) SetID(id string) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *LoginEndpointConfigMutation) ID() (id string, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *LoginEndpointConfigMutation) IDs(ctx context.Context) ([]string, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().LoginEndpointConfig.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetEndpoint sets the "endpoint" field.
func (m *LoginEndpointConfigMutation) SetEndpoint(s string) {
	m.endpoint = &s
}

// Endpoint returns the value of the "endpoint" field in the mutation.
func (m *LoginEndpointConfigMutation) Endpoint() (r string, exists bool) {
	v := m.endpoint
	if v == nil {
		return
	}
...
// OldEndpoint returns the old "endpoint" field's value of the LoginEndpointConfig entity.
// If the LoginEndpointConfig object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *LoginEndpointConfigMutation) OldEndpoint(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldEndpoint is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetEndpoint resets all changes to the "endpoint" field.
func (m *LoginEndpointConfigMutation) ResetEndpoint() {
	m.endpoint = nil
}

// SetSessionTimeout sets the "session_timeout" field.
func (m *LoginEndpointConfigMutation) SetSessionTimeout(i int64) {
	m.session_timeout = &i
	m.addsession_timeout = nil
}

// SessionTimeout returns the value of the "session_timeout" field in the mutation.
func (m *LoginEndpointConfigMutation) SessionTimeout() (r int64, exists bool) {
	v := m.session_timeout
	if v == nil {
		return
	}
...
// OldSessionTimeout returns the old "session_timeout" field's value of the LoginEndpointConfig entity.
// If the LoginEndpointConfig object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *LoginEndpointConfigMutation) OldSessionTimeout(ctx context.Context) (v int64, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldSessionTimeout is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldSessionTimeout requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldSessionTimeout: %w", err)
	}
	return oldValue.SessionTimeout, nil
}

// AddSessionTimeout adds i to the "session_timeout" field.
func (m *LoginEndpointConfigMutation) AddSessionTimeout(i int64) {
	if m.addsession_timeout != nil {
		*m.addsession_timeout += i
	} else {
		m.addsession_timeout = &i
	}
}

// AddedSessionTimeout returns the value that was added to the "session_timeout" field in this mutation.
func (m *LoginEndpointConfigMutation) AddedSessionTimeout() (r int64, exists bool) {
	v := m.addsession_timeout
	if v == nil {
		return
	}
	return *v, true
...
// ResetSessionTimeout resets all changes to the "session_timeout" field.
func (m *LoginEndpointConfigMutation) ResetSessionTimeout() {
	m.session_timeout = nil
	m.addsession_timeout = nil
}

// SetServiceID sets the "service" edge to the Service entity by id.
func (m *LoginEndpointConfigMutation) SetServiceID(id string) {
	m.service = &id
}

// ClearService clears the "service" edge to the Service entity.
func (m *LoginEndpointConfigMutation) ClearService() {
	m.clearedservice = true
}

// ServiceCleared reports if the "service" edge to the Service entity was cleared.
func (m *LoginEndpointConfigMutation) ServiceCleared() bool {
	return m.clearedservice
}

// ServiceID returns the "service" edge ID in the mutation.
func (m *LoginEndpointConfigMutation) ServiceID() (id string, exists bool) {
	if m.service != nil {
		return *m.service, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ServiceID instead. It exists only for internal usage by the builders.
func (m *LoginEndpointConfigMutation) ServiceIDs() (ids []string) {
	if id := m.service; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetService resets all changes to the "service" edge.
func (m *LoginEndpointConfigMutation) ResetService() {
	m.service = nil
	m.clearedservice = false
}

// Where appends a list predicates to the LoginEndpointConfigMutation builder.
func (m *LoginEndpointConfigMutation) Where(ps ...predicate.LoginEndpointConfig) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the LoginEndpointConfigMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *LoginEndpointConfigMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.LoginEndpointConfig, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *LoginEndpointConfigMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *LoginEndpointConfigMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (LoginEndpointConfig).
func (m *LoginEndpointConfigMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *LoginEndpointConfigMutation) Fields() []string {
	fields := make([]string, 0, 2)
	if m.endpoint != nil {
		fields = append(fields, loginendpointconfig.FieldEndpoint)
	}
	if m.session_timeout != nil {
		fields = append(fields, loginendpointconfig.FieldSessionTimeout)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *LoginEndpointConfigMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *LoginEndpointConfigMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case loginendpointconfig.FieldEndpoint:
		return m.OldEndpoint(ctx)
	case loginendpointconfig.FieldSessionTimeout:
		return m.OldSessionTimeout(ctx)
	}
	return nil, fmt.Errorf("unknown LoginEndpointConfig field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *LoginEndpointConfigMutation) SetField(name string, value ent.Value) error {
	switch name {
	case loginendpointconfig.FieldEndpoint:
		v, ok := value.(string)
		if !ok {
	...
	case loginendpointconfig.FieldSessionTimeout:
		...
		m.SetSessionTimeout(v)
		return nil
	}
	return fmt.Errorf("unknown LoginEndpointConfig field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *LoginEndpointConfigMutation) AddedFields() []string {
	var fields []string
	if m.addsession_timeout != nil {
		fields = append(fields, loginendpointconfig.FieldSessionTimeout)
	}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *LoginEndpointConfigMutation) AddedField(name string) (ent.Value, bool) {
	switch name {
	case loginendpointconfig.FieldSessionTimeout:
		return m.AddedSessionTimeout()
	}
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *LoginEndpointConfigMutation) AddField(name string, value ent.Value) error {
	switch name {
	case loginendpointconfig.FieldSessionTimeout:
		v, ok := value.(int64)
		if !ok {
		...
		m.AddSessionTimeout(v)
		return nil
	}
	return fmt.Errorf("unknown LoginEndpointConfig numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *LoginEndpointConfigMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *LoginEndpointConfigMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *LoginEndpointConfigMutation) ClearField(name string) error {
	return fmt.Errorf("unknown LoginEndpointConfig nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *LoginEndpointConfigMutation) ResetField(name string) error {
	switch name {
	case loginendpointconfig.FieldEndpoint:
		m.ResetEndpoint()
		return nil
	case loginendpointconfig.FieldSessionTimeout:
		m.ResetSessionTimeout()
		return nil
	}
	return fmt.Errorf("unknown LoginEndpointConfig field %s", name)
}
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *LoginEndpointConfigMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.service != nil {
		edges = append(edges, loginendpointconfig.EdgeService)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *LoginEndpointConfigMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case loginendpointconfig.EdgeService:
		if id := m.service; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *LoginEndpointConfigMutation) RemovedEdges() []string {
	edges := make([]string, 0, 1)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *LoginEndpointConfigMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *LoginEndpointConfigMutation) ClearedEdges() []string {
	edges := make([]string, 0, 1)
	if m.clearedservice {
		edges = append(edges, loginendpointconfig.EdgeService)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *LoginEndpointConfigMutation) EdgeCleared(name string) bool {
	switch name {
	case loginendpointconfig.EdgeService:
		return m.clearedservice
	}
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *LoginEndpointConfigMutation) ClearEdge(name string) error {
	switch name {
	case loginendpointconfig.EdgeService:
		m.ClearService()
		return nil
	}
	return fmt.Errorf("unknown LoginEndpointConfig unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *LoginEndpointConfigMutation) ResetEdge(name string) error {
	switch name {
	case loginendpointconfig.EdgeService:
		m.ResetService()
		return nil
	}
	return fmt.Errorf("unknown LoginEndpointConfig edge %s", name)
}

// OIDCConnectionMutation represents an operation that mutates the OIDCConnection nodes in the graph.
type OIDCConnectionMutation struct {
	config
	op                              Op
	typ                             string
	id                              *string
	...
	appendscopes                    []string
	redirect_uri                    *string
	well_known_openid_configuration *string
	clearedFields                   map[string]struct{}
	connection_config               *string
	clearedconnection_config        bool
	users                           *string
	...
	oldValue                        func(context.Context) (*OIDCConnection, error)
	predicates                      []predicate.OIDCConnection
}

var _ ent.Mutation = (*OIDCConnectionMutation)(nil)

// oidcconnectionOption allows management of the mutation configuration using functional options.
type oidcconnectionOption func(*OIDCConnectionMutation)

// newOIDCConnectionMutation creates new mutation for the OIDCConnection entity.
func newOIDCConnectionMutation(c config, op Op, opts ...oidcconnectionOption) *OIDCConnectionMutation {
	m := &OIDCConnectionMutation{
		config:        c,
		op:            op,
		typ:           TypeOIDCConnection,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withOIDCConnectionID sets the ID field of the mutation.
func withOIDCConnectionID(id string) oidcconnectionOption {
	return func(m *OIDCConnectionMutation) {
		var (
			err   error
			once  sync.Once
			value *OIDCConnection
		)
		m.oldValue = func(ctx context.Context) (*OIDCConnection, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().OIDCConnection.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withOIDCConnection sets the old OIDCConnection of the mutation.
func withOIDCConnection(node *OIDCConnection) oidcconnectionOption {
	return func(m *OIDCConnectionMutation) {
		m.oldValue = func(context.Context) (*OIDCConnection, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m OIDCConnectionMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m OIDCConnectionMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of OIDCConnection entities.
func (m *OIDCConnectionMutation) SetID(id string) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *OIDCConnectionMutation) ID() (id string, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *OIDCConnectionMutation) IDs(ctx context.Context) ([]string, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().OIDCConnection.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetEnabled sets the "enabled" field.
func (m *OIDCConnectionMutation) SetEnabled(b bool) {
	m.enabled = &b
}

// Enabled returns the value of the "enabled" field in the mutation.
func (m *OIDCConnectionMutation) Enabled() (r bool, exists bool) {
	v := m.enabled
	if v == nil {
		return
	}
...
// OldEnabled returns the old "enabled" field's value of the OIDCConnection entity.
// If the OIDCConnection object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *OIDCConnectionMutation) OldEnabled(ctx context.Context) (v bool, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldEnabled is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetEnabled resets all changes to the "enabled" field.
func (m *OIDCConnectionMutation) ResetEnabled() {
	m.enabled = nil
}

// SetClientID sets the "client_id" field.
func (m *OIDCConnectionMutation) SetClientID(s string) {
	m.client_id = &s
}

// ClientID returns the value of the "client_id" field in the mutation.
func (m *OIDCConnectionMutation) ClientID() (r string, exists bool) {
	v := m.client_id
	if v == nil {
		return
	}
...
// OldClientID returns the old "client_id" field's value of the OIDCConnection entity.
// If the OIDCConnection object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *OIDCConnectionMutation) OldClientID(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldClientID is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *OIDCConnectionMutation) ClearClientID() {
	m.client_id = nil
	m.clearedFields[oidcconnection.FieldClientID] = struct{}{}
}

// ClientIDCleared returns if the "client_id" field was cleared in this mutation.
func (m *OIDCConnectionMutation) ClientIDCleared() bool {
	_, ok := m.clearedFields[oidcconnection.FieldClientID]
	return ok
}

// ResetClientID resets all changes to the "client_id" field.
func (m *OIDCConnectionMutation) ResetClientID() {
	m.client_id = nil
	delete(m.clearedFields, oidcconnection.FieldClientID)
}

// SetClientSecret sets the "client_secret" field.
func (m *OIDCConnectionMutation) SetClientSecret(s string) {
	m.client_secret = &s
}

// ClientSecret returns the value of the "client_secret" field in the mutation.
func (m *OIDCConnectionMutation) ClientSecret() (r string, exists bool) {
	v := m.client_secret
	if v == nil {
		return
	}
...
// OldClientSecret returns the old "client_secret" field's value of the OIDCConnection entity.
// If the OIDCConnection object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *OIDCConnectionMutation) OldClientSecret(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldClientSecret is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *OIDCConnectionMutation) ClearClientSecret() {
	m.client_secret = nil
	m.clearedFields[oidcconnection.FieldClientSecret] = struct{}{}
}

// ClientSecretCleared returns if the "client_secret" field was cleared in this mutation.
func (m *OIDCConnectionMutation) ClientSecretCleared() bool {
	_, ok := m.clearedFields[oidcconnection.FieldClientSecret]
	return ok
}

// ResetClientSecret resets all changes to the "client_secret" field.
func (m *OIDCConnectionMutation) ResetClientSecret() {
	m.client_secret = nil
	delete(m.clearedFields, oidcconnection.FieldClientSecret)
}

// SetScopes sets the "scopes" field.
func (m *OIDCConnectionMutation) SetScopes(s []string) {
	m.scopes = &s
	m.appendscopes = nil
}

// Scopes returns the value of the "scopes" field in the mutation.
func (m *OIDCConnectionMutation) Scopes() (r []string, exists bool) {
	v := m.scopes
	if v == nil {
		return
	}
...
// OldScopes returns the old "scopes" field's value of the OIDCConnection entity.
// If the OIDCConnection object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *OIDCConnectionMutation) OldScopes(ctx context.Context) (v []string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldScopes is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AppendScopes adds s to the "scopes" field.
func (m *OIDCConnectionMutation) AppendScopes(s []string) {
	m.appendscopes = append(m.appendscopes, s...)
}

// AppendedScopes returns the list of values that were appended to the "scopes" field in this mutation.
func (m *OIDCConnectionMutation) AppendedScopes() ([]string, bool) {
	if len(m.appendscopes) == 0 {
		return nil, false
	}
	return m.appendscopes, true
...
func (m *OIDCConnectionMutation) ClearScopes() {
	m.scopes = nil
	m.appendscopes = nil
	m.clearedFields[oidcconnection.FieldScopes] = struct{}{}
}

// ScopesCleared returns if the "scopes" field was cleared in this mutation.
func (m *OIDCConnectionMutation) ScopesCleared() bool {
	_, ok := m.clearedFields[oidcconnection.FieldScopes]
	return ok
}

// ResetScopes resets all changes to the "scopes" field.
func (m *OIDCConnectionMutation) ResetScopes() {
	m.scopes = nil
	m.appendscopes = nil
	delete(m.clearedFields, oidcconnection.FieldScopes)
}

// SetRedirectURI sets the "redirect_uri" field.
func (m *OIDCConnectionMutation) SetRedirectURI(s string) {
	m.redirect_uri = &s
}

// RedirectURI returns the value of the "redirect_uri" field in the mutation.
func (m *OIDCConnectionMutation) RedirectURI() (r string, exists bool) {
	v := m.redirect_uri
	if v == nil {
		return
	}
...
// OldRedirectURI returns the old "redirect_uri" field's value of the OIDCConnection entity.
// If the OIDCConnection object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *OIDCConnectionMutation) OldRedirectURI(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldRedirectURI is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
func (m *OIDCConnectionMutation) ClearRedirectURI() {
	m.redirect_uri = nil
	m.clearedFields[oidcconnection.FieldRedirectURI] = struct{}{}
}

// RedirectURICleared returns if the "redirect_uri" field was cleared in this mutation.
func (m *OIDCConnectionMutation) RedirectURICleared() bool {
	_, ok := m.clearedFields[oidcconnection.FieldRedirectURI]
	return ok
}

// ResetRedirectURI resets all changes to the "redirect_uri" field.
func (m *OIDCConnectionMutation) ResetRedirectURI() {
	m.redirect_uri = nil
	delete(m.clearedFields, oidcconnection.FieldRedirectURI)
}

// SetWellKnownOpenidConfiguration sets the "well_known_openid_configuration" field.
func (m *OIDCConnectionMutation) SetWellKnownOpenidConfiguration(s string) {
	m.well_known_openid_configuration = &s
}

// WellKnownOpenidConfiguration returns the value of the "well_known_openid_configuration" field in the mutation.
func (m *OIDCConnectionMutation) WellKnownOpenidConfiguration() (r string, exists bool) {
	v := m.well_known_openid_configuration
	if v == nil {
		return
	}
	return *v, true
...
// OldWellKnownOpenidConfiguration returns the old "well_known_openid_configuration" field's value of the OIDCConnection entity.
// If the OIDCConnection object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *OIDCConnectionMutation) OldWellKnownOpenidConfiguration(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldWellKnownOpenidConfiguration is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldWellKnownOpenidConfiguration requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldWellKnownOpenidConfiguration: %w", err)
	}
	return oldValue.WellKnownOpenidConfiguration, nil
}

// ClearWellKnownOpenidConfiguration clears the value of the "well_known_openid_configuration" field.
func (m *OIDCConnectionMutation) ClearWellKnownOpenidConfiguration() {
	m.well_known_openid_configuration = nil
	m.clearedFields[oidcconnection.FieldWellKnownOpenidConfiguration] = struct{}{}
}

// WellKnownOpenidConfigurationCleared returns if the "well_known_openid_configuration" field was cleared in this mutation.
func (m *OIDCConnectionMutation) WellKnownOpenidConfigurationCleared() bool {
	_, ok := m.clearedFields[oidcconnection.FieldWellKnownOpenidConfiguration]
	return ok
}

// ResetWellKnownOpenidConfiguration resets all changes to the "well_known_openid_configuration" field.
func (m *OIDCConnectionMutation) ResetWellKnownOpenidConfiguration() {
	m.well_known_openid_configuration = nil
	delete(m.clearedFields, oidcconnection.FieldWellKnownOpenidConfiguration)
}

// SetConnectionConfigID sets the "connection_config" edge to the ConnectionConfig entity by id.
func (m *OIDCConnectionMutation) SetConnectionConfigID(id string) {
	m.connection_config = &id
}

// ClearConnectionConfig clears the "connection_config" edge to the ConnectionConfig entity.
func (m *OIDCConnectionMutation) ClearConnectionConfig() {
	m.clearedconnection_config = true
}

// ConnectionConfigCleared reports if the "connection_config" edge to the ConnectionConfig entity was cleared.
func (m *OIDCConnectionMutation) ConnectionConfigCleared() bool {
	return m.clearedconnection_config
}

// ConnectionConfigID returns the "connection_config" edge ID in the mutation.
func (m *OIDCConnectionMutation) ConnectionConfigID() (id string, exists bool) {
	if m.connection_config != nil {
		return *m.connection_config, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ConnectionConfigID instead. It exists only for internal usage by the builders.
func (m *OIDCConnectionMutation) ConnectionConfigIDs() (ids []string) {
	if id := m.connection_config; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetConnectionConfig resets all changes to the "connection_config" edge.
func (m *OIDCConnectionMutation) ResetConnectionConfig() {
	m.connection_config = nil
	m.clearedconnection_config = false
}

// SetUsersID sets the "users" edge to the User entity by id.
func (m *OIDCConnectionMutation) SetUsersID(id string) {
	m.users = &id
}

// ClearUsers clears the "users" edge to the User entity.
func (m *OIDCConnectionMutation) ClearUsers() {
	m.clearedusers = true
}

// UsersCleared reports if the "users" edge to the User entity was cleared.
func (m *OIDCConnectionMutation) UsersCleared() bool {
	return m.clearedusers
}

// UsersID returns the "users" edge ID in the mutation.
func (m *OIDCConnectionMutation) UsersID() (id string, exists bool) {
	if m.users != nil {
		return *m.users, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// UsersID instead. It exists only for internal usage by the builders.
func (m *OIDCConnectionMutation) UsersIDs() (ids []string) {
	if id := m.users; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetUsers resets all changes to the "users" edge.
func (m *OIDCConnectionMutation) ResetUsers() {
	m.users = nil
	m.clearedusers = false
}

// Where appends a list predicates to the OIDCConnectionMutation builder.
func (m *OIDCConnectionMutation) Where(ps ...predicate.OIDCConnection) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the OIDCConnectionMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *OIDCConnectionMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.OIDCConnection, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *OIDCConnectionMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *OIDCConnectionMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (OIDCConnection).
func (m *OIDCConnectionMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *OIDCConnectionMutation) Fields() []string {
	fields := make([]string, 0, 6)
	if m.enabled != nil {
		fields = append(fields, oidcconnection.FieldEnabled)
	}
	if m.client_id != nil {
		fields = append(fields, oidcconnection.FieldClientID)
	}
	if m.client_secret != nil {
		fields = append(fields, oidcconnection.FieldClientSecret)
	}
	if m.scopes != nil {
		fields = append(fields, oidcconnection.FieldScopes)
	}
	if m.redirect_uri != nil {
		fields = append(fields, oidcconnection.FieldRedirectURI)
	}
	if m.well_known_openid_configuration != nil {
		fields = append(fields, oidcconnection.FieldWellKnownOpenidConfiguration)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *OIDCConnectionMutation) Field(name string) (ent.Value, bool) {
	switch name {
	...
	case oidcconnection.FieldWellKnownOpenidConfiguration:
		return m.WellKnownOpenidConfiguration()
	}
	return nil, false
}
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *OIDCConnectionMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case oidcconnection.FieldEnabled:
		return m.OldEnabled(ctx)
	case oidcconnection.FieldClientID:
	...
	case oidcconnection.FieldRedirectURI:
		return m.OldRedirectURI(ctx)
	case oidcconnection.FieldWellKnownOpenidConfiguration:
		return m.OldWellKnownOpenidConfiguration(ctx)
	}
	return nil, fmt.Errorf("unknown OIDCConnection field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *OIDCConnectionMutation) SetField(name string, value ent.Value) error {
	switch name {
	case oidcconnection.FieldEnabled:
		v, ok := value.(bool)
		if !ok {
	...
	case oidcconnection.FieldWellKnownOpenidConfiguration:
		...
		m.SetWellKnownOpenidConfiguration(v)
		return nil
	}
	return fmt.Errorf("unknown OIDCConnection field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *OIDCConnectionMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *OIDCConnectionMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *OIDCConnectionMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown OIDCConnection numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *OIDCConnectionMutation) ClearedFields() []string {
	var fields []string
	if m.FieldCleared(oidcconnection.FieldClientID) {
		fields = append(fields, oidcconnection.FieldClientID)
	}
	if m.FieldCleared(oidcconnection.FieldClientSecret) {
		fields = append(fields, oidcconnection.FieldClientSecret)
	}
	if m.FieldCleared(oidcconnection.FieldScopes) {
		fields = append(fields, oidcconnection.FieldScopes)
	}
	if m.FieldCleared(oidcconnection.FieldRedirectURI) {
		fields = append(fields, oidcconnection.FieldRedirectURI)
	}
	if m.FieldCleared(oidcconnection.FieldWellKnownOpenidConfiguration) {
		fields = append(fields, oidcconnection.FieldWellKnownOpenidConfiguration)
	}
	return fields
}
...
// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *OIDCConnectionMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *OIDCConnectionMutation) ClearField(name string) error {
	switch name {
	case oidcconnection.FieldClientID:
		m.ClearClientID()
		return nil
	...
	case oidcconnection.FieldRedirectURI:
		...
		return nil
	case oidcconnection.FieldWellKnownOpenidConfiguration:
		m.ClearWellKnownOpenidConfiguration()
		return nil
	}
	return fmt.Errorf("unknown OIDCConnection nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *OIDCConnectionMutation) ResetField(name string) error {
	switch name {
	case oidcconnection.FieldEnabled:
		m.ResetEnabled()
		return nil
	...
	case oidcconnection.FieldRedirectURI:
		...
		return nil
	case oidcconnection.FieldWellKnownOpenidConfiguration:
		m.ResetWellKnownOpenidConfiguration()
		return nil
	}
	return fmt.Errorf("unknown OIDCConnection field %s", name)
}
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *OIDCConnectionMutation) AddedEdges() []string {
	edges := make([]string, 0, 2)
	if m.connection_config != nil {
		edges = append(edges, oidcconnection.EdgeConnectionConfig)
	}
	if m.users != nil {
		edges = append(edges, oidcconnection.EdgeUsers)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *OIDCConnectionMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case oidcconnection.EdgeConnectionConfig:
		if id := m.connection_config; id != nil {
			return []ent.Value{*id}
		}
	case oidcconnection.EdgeUsers:
		if id := m.users; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *OIDCConnectionMutation) RemovedEdges() []string {
	edges := make([]string, 0, 2)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *OIDCConnectionMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *OIDCConnectionMutation) ClearedEdges() []string {
	edges := make([]string, 0, 2)
	if m.clearedconnection_config {
		edges = append(edges, oidcconnection.EdgeConnectionConfig)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *OIDCConnectionMutation) EdgeCleared(name string) bool {
	switch name {
	case oidcconnection.EdgeConnectionConfig:
		return m.clearedconnection_config
	case oidcconnection.EdgeUsers:
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *OIDCConnectionMutation) ClearEdge(name string) error {
	switch name {
	case oidcconnection.EdgeConnectionConfig:
		m.ClearConnectionConfig()
		return nil
	...
	return fmt.Errorf("unknown OIDCConnection unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *OIDCConnectionMutation) ResetEdge(name string) error {
	switch name {
	case oidcconnection.EdgeConnectionConfig:
		m.ResetConnectionConfig()
		return nil
	...
	return fmt.Errorf("unknown OIDCConnection edge %s", name)
}
...
type ServiceMutation struct {
	...
	service_login_endpoint_config                *string
	clearedservice_login_endpoint_config         bool
	service_connection_config                    *string
	clearedservice_connection_config             bool
...
// ClearServiceAuthorizationEndpointConfig clears the "service_authorization_endpoint_config" edge to the AuthorizationEndpointConfig entity.
func (m *ServiceMutation) ClearServiceAuthorizationEndpointConfig() {
	m.clearedservice_authorization_endpoint_config = true
}

// ServiceAuthorizationEndpointConfigCleared reports if the "service_authorization_endpoint_config" edge to the AuthorizationEndpointConfig entity was cleared.
...
// ClearServiceIntrospectionEndpointConfig clears the "service_introspection_endpoint_config" edge to the IntrospectionEndpointConfig entity.
func (m *ServiceMutation) ClearServiceIntrospectionEndpointConfig() {
	m.clearedservice_introspection_endpoint_config = true
}

// ServiceIntrospectionEndpointConfigCleared reports if the "service_introspection_endpoint_config" edge to the IntrospectionEndpointConfig entity was cleared.
...
// ClearServiceTokenEndpointConfig clears the "service_token_endpoint_config" edge to the TokenEndpointConfig entity.
func (m *ServiceMutation) ClearServiceTokenEndpointConfig() {
	m.clearedservice_token_endpoint_config = true
}

// ServiceTokenEndpointConfigCleared reports if the "service_token_endpoint_config" edge to the TokenEndpointConfig entity was cleared.
...
// ClearServiceUserInfoEndpointConfig clears the "service_user_info_endpoint_config" edge to the UserInfoEndpointConfig entity.
func (m *ServiceMutation) ClearServiceUserInfoEndpointConfig() {
	m.clearedservice_user_info_endpoint_config = true
}

// ServiceUserInfoEndpointConfigCleared reports if the "service_user_info_endpoint_config" edge to the UserInfoEndpointConfig entity was cleared.
...
// ClearServiceJwksEndpointConfig clears the "service_jwks_endpoint_config" edge to the JwksEndpointConfig entity.
func (m *ServiceMutation) ClearServiceJwksEndpointConfig() {
	m.clearedservice_jwks_endpoint_config = true
}

// ServiceJwksEndpointConfigCleared reports if the "service_jwks_endpoint_config" edge to the JwksEndpointConfig entity was cleared.
...
func (m *ServiceMutation) SetServiceLoginEndpointConfigID(id string) {
	m.service_login_endpoint_config = &id
}

// ClearServiceLoginEndpointConfig clears the "service_login_endpoint_config" edge to the LoginEndpointConfig entity.
func (m *ServiceMutation) ClearServiceLoginEndpointConfig() {
	m.clearedservice_login_endpoint_config = true
}

// ServiceLoginEndpointConfigCleared reports if the "service_login_endpoint_config" edge to the LoginEndpointConfig entity was cleared.
func (m *ServiceMutation) ServiceLoginEndpointConfigCleared() bool {
	return m.clearedservice_login_endpoint_config
}

// ServiceLoginEndpointConfigID returns the "service_login_endpoint_config" edge ID in the mutation.
func (m *ServiceMutation) ServiceLoginEndpointConfigID() (id string, exists bool) {
	if m.service_login_endpoint_config != nil {
		return *m.service_login_endpoint_config, true
	}
	return
}

// ServiceLoginEndpointConfigIDs returns the "service_login_endpoint_config" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ServiceLoginEndpointConfigID instead. It exists only for internal usage by the builders.
func (m *ServiceMutation) ServiceLoginEndpointConfigIDs() (ids []string) {
	if id := m.service_login_endpoint_config; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetServiceLoginEndpointConfig resets all changes to the "service_login_endpoint_config" edge.
func (m *ServiceMutation) ResetServiceLoginEndpointConfig() {
	m.service_login_endpoint_config = nil
	m.clearedservice_login_endpoint_config = false
}

// SetServiceConnectionConfigID sets the "service_connection_config" edge to the ConnectionConfig entity by id.
func (m *ServiceMutation) SetServiceConnectionConfigID(id string) {
	m.service_connection_config = &id
}

// ClearServiceConnectionConfig clears the "service_connection_config" edge to the ConnectionConfig entity.
func (m *ServiceMutation) ClearServiceConnectionConfig() {
	m.clearedservice_connection_config = true
}

// ServiceConnectionConfigCleared reports if the "service_connection_config" edge to the ConnectionConfig entity was cleared.
func (m *ServiceMutation) ServiceConnectionConfigCleared() bool {
	return m.clearedservice_connection_config
}

// ServiceConnectionConfigID returns the "service_connection_config" edge ID in the mutation.
func (m *ServiceMutation) ServiceConnectionConfigID() (id string, exists bool) {
	if m.service_connection_config != nil {
		return *m.service_connection_config, true
	}
	return
}

// ServiceConnectionConfigIDs returns the "service_connection_config" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ServiceConnectionConfigID instead. It exists only for internal usage by the builders.
func (m *ServiceMutation) ServiceConnectionConfigIDs() (ids []string) {
	if id := m.service_connection_config; id != nil {
		ids = append(ids, *id)
	}
	return
}

// ResetServiceConnectionConfig resets all changes to the "service_connection_config" edge.
func (m *ServiceMutation) ResetServiceConnectionConfig() {
	m.service_connection_config = nil
	m.clearedservice_connection_config = false
}
...
func (m *ServiceMutation) AddedEdges() []string {
	...
	if m.service_login_endpoint_config != nil {
		edges = append(edges, service.EdgeServiceLoginEndpointConfig)
	}
	if m.service_connection_config != nil {
		edges = append(edges, service.EdgeServiceConnectionConfig)
	}
	if m.applications != nil {
...
func (m *ServiceMutation) AddedIDs(name string) []ent.Value {
	...
	case service.EdgeServiceLoginEndpointConfig:
		if id := m.service_login_endpoint_config; id != nil {
			return []ent.Value{*id}
		}
	case service.EdgeServiceConnectionConfig:
		if id := m.service_connection_config; id != nil {
			return []ent.Value{*id}
		}
...
func (m *ServiceMutation) ClearedEdges() []string {
	...
	if m.clearedservice_login_endpoint_config {
		edges = append(edges, service.EdgeServiceLoginEndpointConfig)
	}
	if m.clearedservice_connection_config {
		edges = append(edges, service.EdgeServiceConnectionConfig)
	}
...
func (m *ServiceMutation) ClearEdge(name string) error {
	...
	case service.EdgeServiceWellKnownEndpointConfig:
		...
		return nil
	case service.EdgeServiceLoginEndpointConfig:
		m.ClearServiceLoginEndpointConfig()
		return nil
	case service.EdgeServiceConnectionConfig:
		m.ClearServiceConnectionConfig()
		return nil
	}
...
func (m *ServiceMutation) ResetEdge(name string) error {
	...
	case service.EdgeServiceWellKnownEndpointConfig:
		...
		return nil
	case service.EdgeServiceLoginEndpointConfig:
		m.ResetServiceLoginEndpointConfig()
		return nil
	case service.EdgeServiceConnectionConfig:
		m.ResetServiceConnectionConfig()
		return nil
	case service.EdgeApplications:
		m.ResetApplications()
		return nil
...
// SetServiceName sets the "service_name" field.
func (m *SessionMutation) SetServiceName(s string) {
	m.service_name = &s
}

// ServiceName returns the value of the "service_name" field in the mutation.
func (m *SessionMutation) ServiceName() (r string, exists bool) {
	v := m.service_name
	if v == nil {
		return
	}
...
// OldServiceName returns the old "service_name" field's value of the Session entity.
// If the Session object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SessionMutation) OldServiceName(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldServiceName is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetServiceName resets all changes to the "service_name" field.
func (m *SessionMutation) ResetServiceName() {
	m.service_name = nil
}
...
func (m *SessionMutation) Fields() []string {
	...
	if m.service_name != nil {
		fields = append(fields, session.FieldServiceName)
	}
	return fields
}
...
// TokenEndpointConfigMutation represents an operation that mutates the TokenEndpointConfig nodes in the graph.
type TokenEndpointConfigMutation struct {
	config
	op                                   Op
	typ                                  string
	id                                   *string
	...
	oldValue                             func(context.Context) (*TokenEndpointConfig, error)
	predicates                           []predicate.TokenEndpointConfig
}

var _ ent.Mutation = (*TokenEndpointConfigMutation)(nil)

// tokenendpointconfigOption allows management of the mutation configuration using functional options.
type tokenendpointconfigOption func(*TokenEndpointConfigMutation)

// newTokenEndpointConfigMutation creates new mutation for the TokenEndpointConfig entity.
func newTokenEndpointConfigMutation(c config, op Op, opts ...tokenendpointconfigOption) *TokenEndpointConfigMutation {
	m := &TokenEndpointConfigMutation{
		config:        c,
		op:            op,
		typ:           TypeTokenEndpointConfig,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withTokenEndpointConfigID sets the ID field of the mutation.
func withTokenEndpointConfigID(id string) tokenendpointconfigOption {
	return func(m *TokenEndpointConfigMutation) {
		var (
			err   error
			once  sync.Once
			value *TokenEndpointConfig
		)
		m.oldValue = func(ctx context.Context) (*TokenEndpointConfig, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().TokenEndpointConfig.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withTokenEndpointConfig sets the old TokenEndpointConfig of the mutation.
func withTokenEndpointConfig(node *TokenEndpointConfig) tokenendpointconfigOption {
	return func(m *TokenEndpointConfigMutation) {
		m.oldValue = func(context.Context) (*TokenEndpointConfig, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m TokenEndpointConfigMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m TokenEndpointConfigMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of TokenEndpointConfig entities.
func (m *TokenEndpointConfigMutation) SetID(id string) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *TokenEndpointConfigMutation) ID() (id string, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *TokenEndpointConfigMutation) IDs(ctx context.Context) ([]string, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().TokenEndpointConfig.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetEndpoint sets the "endpoint" field.
func (m *TokenEndpointConfigMutation) SetEndpoint(s string) {
	m.endpoint = &s
}

// Endpoint returns the value of the "endpoint" field in the mutation.
func (m *TokenEndpointConfigMutation) Endpoint() (r string, exists bool) {
	v := m.endpoint
	if v == nil {
		return
	}
...
// OldEndpoint returns the old "endpoint" field's value of the TokenEndpointConfig entity.
// If the TokenEndpointConfig object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TokenEndpointConfigMutation) OldEndpoint(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldEndpoint is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetEndpoint resets all changes to the "endpoint" field.
func (m *TokenEndpointConfigMutation) ResetEndpoint() {
	m.endpoint = nil
}

// SetAllowedAuthenticationMethods sets the "allowed_authentication_methods" field.
func (m *TokenEndpointConfigMutation) SetAllowedAuthenticationMethods(s []string) {
	m.allowed_authentication_methods = &s
	m.appendallowed_authentication_methods = nil
}

// AllowedAuthenticationMethods returns the value of the "allowed_authentication_methods" field in the mutation.
func (m *TokenEndpointConfigMutation) AllowedAuthenticationMethods() (r []string, exists bool) {
	v := m.allowed_authentication_methods
	if v == nil {
		return
	}
...
// OldAllowedAuthenticationMethods returns the old "allowed_authentication_methods" field's value of the TokenEndpointConfig entity.
// If the TokenEndpointConfig object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TokenEndpointConfigMutation) OldAllowedAuthenticationMethods(ctx context.Context) (v []string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldAllowedAuthenticationMethods is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// AppendAllowedAuthenticationMethods adds s to the "allowed_authentication_methods" field.
func (m *TokenEndpointConfigMutation) AppendAllowedAuthenticationMethods(s []string) {
	m.appendallowed_authentication_methods = append(m.appendallowed_authentication_methods, s...)
}

// AppendedAllowedAuthenticationMethods returns the list of values that were appended to the "allowed_authentication_methods" field in this mutation.
func (m *TokenEndpointConfigMutation) AppendedAllowedAuthenticationMethods() ([]string, bool) {
	if len(m.appendallowed_authentication_methods) == 0 {
		return nil, false
	}
	return m.appendallowed_authentication_methods, true
...
// ResetAllowedAuthenticationMethods resets all changes to the "allowed_authentication_methods" field.
func (m *TokenEndpointConfigMutation) ResetAllowedAuthenticationMethods() {
	m.allowed_authentication_methods = nil
	m.appendallowed_authentication_methods = nil
}

// SetServiceID sets the "service" edge to the Service entity by id.
func (m *TokenEndpointConfigMutation) SetServiceID(id string) {
	m.service = &id
}

// ClearService clears the "service" edge to the Service entity.
func (m *TokenEndpointConfigMutation) ClearService() {
	m.clearedservice = true
}

// ServiceCleared reports if the "service" edge to the Service entity was cleared.
func (m *TokenEndpointConfigMutation) ServiceCleared() bool {
	return m.clearedservice
}

// ServiceID returns the "service" edge ID in the mutation.
func (m *TokenEndpointConfigMutation) ServiceID() (id string, exists bool) {
	if m.service != nil {
		return *m.service, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ServiceID instead. It exists only for internal usage by the builders.
func (m *TokenEndpointConfigMutation) ServiceIDs() (ids []string) {
	if id := m.service; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetService resets all changes to the "service" edge.
func (m *TokenEndpointConfigMutation) ResetService() {
	m.service = nil
	m.clearedservice = false
}

// Where appends a list predicates to the TokenEndpointConfigMutation builder.
func (m *TokenEndpointConfigMutation) Where(ps ...predicate.TokenEndpointConfig) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the TokenEndpointConfigMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *TokenEndpointConfigMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.TokenEndpointConfig, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *TokenEndpointConfigMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *TokenEndpointConfigMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (TokenEndpointConfig).
func (m *TokenEndpointConfigMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *TokenEndpointConfigMutation) Fields() []string {
	fields := make([]string, 0, 2)
	if m.endpoint != nil {
		fields = append(fields, tokenendpointconfig.FieldEndpoint)
	}
	if m.allowed_authentication_methods != nil {
		fields = append(fields, tokenendpointconfig.FieldAllowedAuthenticationMethods)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *TokenEndpointConfigMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *TokenEndpointConfigMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case tokenendpointconfig.FieldEndpoint:
		return m.OldEndpoint(ctx)
	case tokenendpointconfig.FieldAllowedAuthenticationMethods:
	...
	return nil, fmt.Errorf("unknown TokenEndpointConfig field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *TokenEndpointConfigMutation) SetField(name string, value ent.Value) error {
	switch name {
	case tokenendpointconfig.FieldEndpoint:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown TokenEndpointConfig field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *TokenEndpointConfigMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *TokenEndpointConfigMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *TokenEndpointConfigMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown TokenEndpointConfig numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *TokenEndpointConfigMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *TokenEndpointConfigMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *TokenEndpointConfigMutation) ClearField(name string) error {
	return fmt.Errorf("unknown TokenEndpointConfig nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *TokenEndpointConfigMutation) ResetField(name string) error {
	switch name {
	case tokenendpointconfig.FieldEndpoint:
		m.ResetEndpoint()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *TokenEndpointConfigMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.service != nil {
		edges = append(edges, tokenendpointconfig.EdgeService)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *TokenEndpointConfigMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case tokenendpointconfig.EdgeService:
		if id := m.service; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *TokenEndpointConfigMutation) RemovedEdges() []string {
	edges := make([]string, 0, 1)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *TokenEndpointConfigMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *TokenEndpointConfigMutation) ClearedEdges() []string {
	edges := make([]string, 0, 1)
	if m.clearedservice {
		edges = append(edges, tokenendpointconfig.EdgeService)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *TokenEndpointConfigMutation) EdgeCleared(name string) bool {
	switch name {
	case tokenendpointconfig.EdgeService:
		return m.clearedservice
	}
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *TokenEndpointConfigMutation) ClearEdge(name string) error {
	switch name {
	case tokenendpointconfig.EdgeService:
		m.ClearService()
		return nil
	}
	return fmt.Errorf("unknown TokenEndpointConfig unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *TokenEndpointConfigMutation) ResetEdge(name string) error {
	switch name {
	case tokenendpointconfig.EdgeService:
		m.ResetService()
		return nil
	}
	return fmt.Errorf("unknown TokenEndpointConfig edge %s", name)
}
...
// SetEmailPasswordConnectionID sets the "email_password_connection" edge to the EmailPasswordConnection entity by id.
func (m *UserMutation) SetEmailPasswordConnectionID(id string) {
	m.email_password_connection = &id
}

// ClearEmailPasswordConnection clears the "email_password_connection" edge to the EmailPasswordConnection entity.
func (m *UserMutation) ClearEmailPasswordConnection() {
	m.clearedemail_password_connection = true
}

// EmailPasswordConnectionCleared reports if the "email_password_connection" edge to the EmailPasswordConnection entity was cleared.
func (m *UserMutation) EmailPasswordConnectionCleared() bool {
	return m.clearedemail_password_connection
}

// EmailPasswordConnectionID returns the "email_password_connection" edge ID in the mutation.
func (m *UserMutation) EmailPasswordConnectionID() (id string, exists bool) {
	if m.email_password_connection != nil {
		return *m.email_password_connection, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// EmailPasswordConnectionID instead. It exists only for internal usage by the builders.
func (m *UserMutation) EmailPasswordConnectionIDs() (ids []string) {
	if id := m.email_password_connection; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetEmailPasswordConnection resets all changes to the "email_password_connection" edge.
func (m *UserMutation) ResetEmailPasswordConnection() {
	m.email_password_connection = nil
	m.clearedemail_password_connection = false
}

// SetOidcConnectionsID sets the "oidc_connections" edge to the OIDCConnection entity by id.
func (m *UserMutation) SetOidcConnectionsID(id string) {
	m.oidc_connections = &id
}

// ClearOidcConnections clears the "oidc_connections" edge to the OIDCConnection entity.
func (m *UserMutation) ClearOidcConnections() {
	m.clearedoidc_connections = true
}

// OidcConnectionsCleared reports if the "oidc_connections" edge to the OIDCConnection entity was cleared.
func (m *UserMutation) OidcConnectionsCleared() bool {
	return m.clearedoidc_connections
}

// OidcConnectionsID returns the "oidc_connections" edge ID in the mutation.
func (m *UserMutation) OidcConnectionsID() (id string, exists bool) {
	if m.oidc_connections != nil {
		return *m.oidc_connections, true
	}
	return
}
...
// OidcConnectionsIDs returns the "oidc_connections" edge IDs in the mutation.
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// OidcConnectionsID instead. It exists only for internal usage by the builders.
func (m *UserMutation) OidcConnectionsIDs() (ids []string) {
	if id := m.oidc_connections; id != nil {
		ids = append(ids, *id)
	}
	return
}
...
// ResetOidcConnections resets all changes to the "oidc_connections" edge.
func (m *UserMutation) ResetOidcConnections() {
	m.oidc_connections = nil
	m.clearedoidc_connections = false
}
...
func (m *UserMutation) AddedEdges() []string {
	...
	if m.email_password_connection != nil {
		edges = append(edges, user.EdgeEmailPasswordConnection)
	}
	if m.oidc_connections != nil {
		edges = append(edges, user.EdgeOidcConnections)
	}
	return edges
}
...
func (m *UserMutation) AddedIDs(name string) []ent.Value {
	...
	case user.EdgeEmailPasswordConnection:
		if id := m.email_password_connection; id != nil {
			return []ent.Value{*id}
		}
	case user.EdgeOidcConnections:
		if id := m.oidc_connections; id != nil {
			return []ent.Value{*id}
		}
	}
...
// UserInfoEndpointConfigMutation represents an operation that mutates the UserInfoEndpointConfig nodes in the graph.
type UserInfoEndpointConfigMutation struct {
	config
	op             Op
	typ            string
	id             *string
	...
	oldValue       func(context.Context) (*UserInfoEndpointConfig, error)
	predicates     []predicate.UserInfoEndpointConfig
}

var _ ent.Mutation = (*UserInfoEndpointConfigMutation)(nil)

// userinfoendpointconfigOption allows management of the mutation configuration using functional options.
type userinfoendpointconfigOption func(*UserInfoEndpointConfigMutation)

// newUserInfoEndpointConfigMutation creates new mutation for the UserInfoEndpointConfig entity.
func newUserInfoEndpointConfigMutation(c config, op Op, opts ...userinfoendpointconfigOption) *UserInfoEndpointConfigMutation {
	m := &UserInfoEndpointConfigMutation{
		config:        c,
		op:            op,
		typ:           TypeUserInfoEndpointConfig,
		clearedFields: make(map[string]struct{}),
	}
	for _, opt := range opts {
		opt(m)
...
// withUserInfoEndpointConfigID sets the ID field of the mutation.
func withUserInfoEndpointConfigID(id string) userinfoendpointconfigOption {
	return func(m *UserInfoEndpointConfigMutation) {
		var (
			err   error
			once  sync.Once
			value *UserInfoEndpointConfig
		)
		m.oldValue = func(ctx context.Context) (*UserInfoEndpointConfig, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().UserInfoEndpointConfig.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withUserInfoEndpointConfig sets the old UserInfoEndpointConfig of the mutation.
func withUserInfoEndpointConfig(node *UserInfoEndpointConfig) userinfoendpointconfigOption {
	return func(m *UserInfoEndpointConfigMutation) {
		m.oldValue = func(context.Context) (*UserInfoEndpointConfig, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
// Client returns a new `ent.Client` from the mutation. If the mutation was
// executed in a transaction (ent.Tx), a transactional client is returned.
func (m UserInfoEndpointConfigMutation) Client() *Client {
	client := &Client{config: m.config}
	client.init()
	return client
}
...
// Tx returns an `ent.Tx` for mutations that were executed in transactions;
// it returns an error otherwise.
func (m UserInfoEndpointConfigMutation) Tx() (*Tx, error) {
	if _, ok := m.driver.(*txDriver); !ok {
		return nil, errors.New("ent: mutation is not running in a transaction")
	}
	tx := &Tx{config: m.config}
...
// SetID sets the value of the id field. Note that this
// operation is only accepted on creation of UserInfoEndpointConfig entities.
func (m *UserInfoEndpointConfigMutation) SetID(id string) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *UserInfoEndpointConfigMutation) ID() (id string, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
// as sql.LevelSerializable, the returned ids match the ids of the rows that will be updated
// or updated by the mutation.
func (m *UserInfoEndpointConfigMutation) IDs(ctx context.Context) ([]string, error) {
	switch {
	case m.op.Is(OpUpdateOne | OpDeleteOne):
		id, exists := m.ID()
		if exists {
		...
		fallthrough
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().UserInfoEndpointConfig.Query().Where(m.predicates...).IDs(ctx)
	default:
		return nil, fmt.Errorf("IDs is not allowed on %s operations", m.op)
	}
}
...
// SetEndpoint sets the "endpoint" field.
func (m *UserInfoEndpointConfigMutation) SetEndpoint(s string) {
	m.endpoint = &s
}

// Endpoint returns the value of the "endpoint" field in the mutation.
func (m *UserInfoEndpointConfigMutation) Endpoint() (r string, exists bool) {
	v := m.endpoint
	if v == nil {
		return
	}
...
// OldEndpoint returns the old "endpoint" field's value of the UserInfoEndpointConfig entity.
// If the UserInfoEndpointConfig object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *UserInfoEndpointConfigMutation) OldEndpoint(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldEndpoint is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetEndpoint resets all changes to the "endpoint" field.
func (m *UserInfoEndpointConfigMutation) ResetEndpoint() {
	m.endpoint = nil
}

// SetServiceID sets the "service" edge to the Service entity by id.
func (m *UserInfoEndpointConfigMutation) SetServiceID(id string) {
	m.service = &id
}

// ClearService clears the "service" edge to the Service entity.
func (m *UserInfoEndpointConfigMutation) ClearService() {
	m.clearedservice = true
}

// ServiceCleared reports if the "service" edge to the Service entity was cleared.
func (m *UserInfoEndpointConfigMutation) ServiceCleared() bool {
	return m.clearedservice
}

// ServiceID returns the "service" edge ID in the mutation.
func (m *UserInfoEndpointConfigMutation) ServiceID() (id string, exists bool) {
	if m.service != nil {
		return *m.service, true
	}
	return
...
// Note that IDs always returns len(IDs) <= 1 for unique edges, and you should use
// ServiceID instead. It exists only for internal usage by the builders.
func (m *UserInfoEndpointConfigMutation) ServiceIDs() (ids []string) {
	if id := m.service; id != nil {
		ids = append(ids, *id)
	}
	return
...
// ResetService resets all changes to the "service" edge.
func (m *UserInfoEndpointConfigMutation) ResetService() {
	m.service = nil
	m.clearedservice = false
}

// Where appends a list predicates to the UserInfoEndpointConfigMutation builder.
func (m *UserInfoEndpointConfigMutation) Where(ps ...predicate.UserInfoEndpointConfig) {
	m.predicates = append(m.predicates, ps...)
}

// WhereP appends storage-level predicates to the UserInfoEndpointConfigMutation builder. Using this method,
// users can use type-assertion to append predicates that do not depend on any generated package.
func (m *UserInfoEndpointConfigMutation) WhereP(ps ...func(*sql.Selector)) {
	p := make([]predicate.UserInfoEndpointConfig, len(ps))
	for i := range ps {
		p[i] = ps[i]
	}
	m.Where(p...)
...
// Op returns the operation name.
func (m *UserInfoEndpointConfigMutation) Op() Op {
	return m.op
}

// SetOp allows setting the mutation operation.
func (m *UserInfoEndpointConfigMutation) SetOp(op Op) {
	m.op = op
}

// Type returns the node type of this mutation (UserInfoEndpointConfig).
func (m *UserInfoEndpointConfigMutation) Type() string {
	return m.typ
}
...
// order to get all numeric fields that were incremented/decremented, call
// AddedFields().
func (m *UserInfoEndpointConfigMutation) Fields() []string {
	fields := make([]string, 0, 1)
	if m.endpoint != nil {
		fields = append(fields, userinfoendpointconfig.FieldEndpoint)
	}
	return fields
}
...
// return value indicates that this field was not set, or was not defined in the
// schema.
func (m *UserInfoEndpointConfigMutation) Field(name string) (ent.Value, bool) {
	switch name {
...
// returned if the mutation operation is not UpdateOne, or the query to the
// database failed.
func (m *UserInfoEndpointConfigMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	switch name {
	case userinfoendpointconfig.FieldEndpoint:
		return m.OldEndpoint(ctx)
	}
	return nil, fmt.Errorf("unknown UserInfoEndpointConfig field %s", name)
}

// SetField sets the value of a field with the given name. It returns an error if
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *UserInfoEndpointConfigMutation) SetField(name string, value ent.Value) error {
	switch name {
	case userinfoendpointconfig.FieldEndpoint:
		v, ok := value.(string)
		if !ok {
	...
	return fmt.Errorf("unknown UserInfoEndpointConfig field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *UserInfoEndpointConfigMutation) AddedFields() []string {
	return nil
}
...
// with the given name. The second boolean return value indicates that this field
// was not set, or was not defined in the schema.
func (m *UserInfoEndpointConfigMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *UserInfoEndpointConfigMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown UserInfoEndpointConfig numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *UserInfoEndpointConfigMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *UserInfoEndpointConfigMutation) FieldCleared(name string) bool {
	_, ok := m.clearedFields[name]
	return ok
}
...
// ClearField clears the value of the field with the given name. It returns an
// error if the field is not defined in the schema.
func (m *UserInfoEndpointConfigMutation) ClearField(name string) error {
	return fmt.Errorf("unknown UserInfoEndpointConfig nullable field %s", name)
}

// ResetField resets all changes in the mutation for the field with the given name.
// It returns an error if the field is not defined in the schema.
func (m *UserInfoEndpointConfigMutation) ResetField(name string) error {
	switch name {
	case userinfoendpointconfig.FieldEndpoint:
		m.ResetEndpoint()
		return nil
...
// AddedEdges returns all edge names that were set/added in this mutation.
func (m *UserInfoEndpointConfigMutation) AddedEdges() []string {
	edges := make([]string, 0, 1)
	if m.service != nil {
		edges = append(edges, userinfoendpointconfig.EdgeService)
	}
	return edges
}
...
// AddedIDs returns all IDs (to other nodes) that were added for the given edge
// name in this mutation.
func (m *UserInfoEndpointConfigMutation) AddedIDs(name string) []ent.Value {
	switch name {
	case userinfoendpointconfig.EdgeService:
		if id := m.service; id != nil {
			return []ent.Value{*id}
		}
	}
...
// RemovedEdges returns all edge names that were removed in this mutation.
func (m *UserInfoEndpointConfigMutation) RemovedEdges() []string {
	edges := make([]string, 0, 1)
	return edges
}
...
// RemovedIDs returns all IDs (to other nodes) that were removed for the edge with
// the given name in this mutation.
func (m *UserInfoEndpointConfigMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *UserInfoEndpointConfigMutation) ClearedEdges() []string {
	edges := make([]string, 0, 1)
	if m.clearedservice {
		edges = append(edges, userinfoendpointconfig.EdgeService)
	}
...
// EdgeCleared returns a boolean which indicates if the edge with the given name
// was cleared in this mutation.
func (m *UserInfoEndpointConfigMutation) EdgeCleared(name string) bool {
	switch name {
	case userinfoendpointconfig.EdgeService:
		return m.clearedservice
	}
...
// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *UserInfoEndpointConfigMutation) ClearEdge(name string) error {
	switch name {
	case userinfoendpointconfig.EdgeService:
		m.ClearService()
		return nil
	}
	return fmt.Errorf("unknown UserInfoEndpointConfig unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *UserInfoEndpointConfigMutation) ResetEdge(name string) error {
	switch name {
	case userinfoendpointconfig.EdgeService:
		m.ResetService()
		return nil
	}
	return fmt.Errorf("unknown UserInfoEndpointConfig edge %s", name)
}
