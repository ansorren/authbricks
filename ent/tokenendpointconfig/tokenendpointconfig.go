...
const (
	// Label holds the string label denoting the tokenendpointconfig type in the database.
	Label = "token_endpoint_config"
	...
	EdgeService = "service"
	// Table holds the table name of the tokenendpointconfig in the database.
	Table = "token_endpoint_configs"
	// ServiceTable is the table that holds the service relation/edge.
	ServiceTable = "token_endpoint_configs"
...
// Columns holds all SQL columns for tokenendpointconfig fields.
var Columns = []string{
	FieldID,
	FieldEndpoint,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "token_endpoint_configs"
...
// OrderOption defines the ordering options for the TokenEndpointConfig queries.
