...
const (
	...
	M2mGrantsColumn = "oauth_client_m2m_grants"
	...
	CodeGrantsColumn = "oauth_client_code_grants"
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "oauth_clients"
