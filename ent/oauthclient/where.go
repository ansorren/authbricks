...
func HasM2mGrants() predicate.OAuthClient {
...
func HasM2mGrantsWith(preds ...predicate.M2MGrant) predicate.OAuthClient {
	return predicate.OAuthClient(func(s *sql.Selector) {
...
func HasCodeGrants() predicate.OAuthClient {
	return predicate.OAuthClient(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasCodeGrantsWith(preds ...predicate.CodeGrant) predicate.OAuthClient {
	return predicate.OAuthClient(func(s *sql.Selector) {
...
func HasCredentials() predicate.OAuthClient {
	return predicate.OAuthClient(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasCredentialsWith(preds ...predicate.Credentials) predicate.OAuthClient {
	return predicate.OAuthClient(func(s *sql.Selector) {
...
func HasServer() predicate.OAuthClient {
	return predicate.OAuthClient(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasServerWith(preds ...predicate.OAuthServer) predicate.OAuthClient {
	return predicate.OAuthClient(func(s *sql.Selector) {
		step := newServerStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
