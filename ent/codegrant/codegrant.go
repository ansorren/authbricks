...
const (
	// Label holds the string label denoting the codegrant type in the database.
	Label = "code_grant"
	...
	ClientColumn = "oauth_client_code_grants"
)
...
// OrderOption defines the ordering options for the CodeGrant queries.
