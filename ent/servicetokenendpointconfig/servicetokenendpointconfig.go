...
const (
	// Label holds the string label denoting the servicetokenendpointconfig type in the database.
	Label = "service_token_endpoint_config"
	...
	EdgeService = "service"
	// Table holds the table name of the servicetokenendpointconfig in the database.
	Table = "service_token_endpoint_configs"
	// ServiceTable is the table that holds the service relation/edge.
	ServiceTable = "service_token_endpoint_configs"
	// ServiceInverseTable is the table name for the Service entity.
	// It exists in this package in order to avoid circular dependency with the "service" package.
	ServiceInverseTable = "services"
	// ServiceColumn is the table column denoting the service relation/edge.
	ServiceColumn = "service_service_token_endpoint_config"
)

// Columns holds all SQL columns for servicetokenendpointconfig fields.
var Columns = []string{
	FieldID,
	FieldEndpoint,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "service_token_endpoint_configs"
// table and are not defined as standalone fields in the schema.
var ForeignKeys = []string{
	"service_service_token_endpoint_config",
}
...
// OrderOption defines the ordering options for the ServiceTokenEndpointConfig queries.
