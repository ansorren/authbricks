...
func (aq *ApplicationQuery) QueryM2mGrants() *M2MGrantQuery {
...
func (aq *ApplicationQuery) QueryCodeGrants() *CodeGrantQuery {
...
func (aq *ApplicationQuery) QueryCredentials() *CredentialsQuery {
	query := (&CredentialsClient{config: aq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := aq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (aq *ApplicationQuery) QueryService() *ServiceQuery {
	query := (&ServiceClient{config: aq.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := aq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (aq *ApplicationQuery) Clone() *ApplicationQuery {
	...
	return &ApplicationQuery{
		...
		withM2mGrants:   aq.withM2mGrants.Clone(),
		withCodeGrants:  aq.withCodeGrants.Clone(),
...
func (aq *ApplicationQuery) WithM2mGrants(opts ...func(*M2MGrantQuery)) *ApplicationQuery {
	query := (&M2MGrantClient{config: aq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	aq.withM2mGrants = query
	return aq
}
...
func (aq *ApplicationQuery) WithCodeGrants(opts ...func(*CodeGrantQuery)) *ApplicationQuery {
	query := (&CodeGrantClient{config: aq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	aq.withCodeGrants = query
	return aq
}
...
func (aq *ApplicationQuery) WithCredentials(opts ...func(*CredentialsQuery)) *ApplicationQuery {
	query := (&CredentialsClient{config: aq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (aq *ApplicationQuery) WithService(opts ...func(*ServiceQuery)) *ApplicationQuery {
	query := (&ServiceClient{config: aq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	aq.withService = query
	return aq
}
...
func (aq *ApplicationQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Application, error) {
	var (
		...
		_spec       = aq.querySpec()
		loadedTypes = [4]bool{
			aq.withM2mGrants != nil,
			aq.withCodeGrants != nil,
			aq.withCredentials != nil,
			aq.withService != nil,
		}
	)
	if aq.withService != nil {
		withFKs = true
	}
	if withFKs {
	...
	if query := aq.withM2mGrants; query != nil {
		if err := aq.loadM2mGrants(ctx, query, nodes, nil,
			func(n *Application, e *M2MGrant) { n.Edges.M2mGrants = e }); err != nil {
			return nil, err
		}
	}
	if query := aq.withCodeGrants; query != nil {
		if err := aq.loadCodeGrants(ctx, query, nodes, nil,
			func(n *Application, e *CodeGrant) { n.Edges.CodeGrants = e }); err != nil {
			return nil, err
		}
	}
	if query := aq.withCredentials; query != nil {
		if err := aq.loadCredentials(ctx, query, nodes,
			...
			func(n *Application, e *Credentials) { n.Edges.Credentials = append(n.Edges.Credentials, e) }); err != nil {
			return nil, err
		}
	}
	if query := aq.withService; query != nil {
		if err := aq.loadService(ctx, query, nodes, nil,
			func(n *Application, e *Service) { n.Edges.Service = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (aq *ApplicationQuery) loadM2mGrants(ctx context.Context, query *M2MGrantQuery, nodes []*Application, init func(*Application), assign func(*Application, *M2MGrant)) error {
	...
	query.Where(predicate.M2MGrant(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(application.M2mGrantsColumn), fks...))
	}))
	...
	for _, n := range neighbors {
		fk := n.application_m2m_grants
		if fk == nil {
			return fmt.Errorf(`foreign-key "application_m2m_grants" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "application_m2m_grants" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (aq *ApplicationQuery) loadCodeGrants(ctx context.Context, query *CodeGrantQuery, nodes []*Application, init func(*Application), assign func(*Application, *CodeGrant)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[string]*Application)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	query.Where(predicate.CodeGrant(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(application.CodeGrantsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.application_code_grants
		if fk == nil {
			return fmt.Errorf(`foreign-key "application_code_grants" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "application_code_grants" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
...
func (aq *ApplicationQuery) loadCredentials(ctx context.Context, query *CredentialsQuery, nodes []*Application, init func(*Application), assign func(*Application, *Credentials)) error {
	...
	query.Where(predicate.Credentials(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(application.CredentialsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
	...
	for _, n := range neighbors {
		fk := n.application_credentials
		if fk == nil {
			return fmt.Errorf(`foreign-key "application_credentials" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
			return fmt.Errorf(`unexpected referenced foreign-key "application_credentials" returned %v for node %v`, *fk, n.ID)
		}
		assign(node, n)
	}
	return nil
}
func (aq *ApplicationQuery) loadService(ctx context.Context, query *ServiceQuery, nodes []*Application, init func(*Application), assign func(*Application, *Service)) error {
	ids := make([]string, 0, len(nodes))
	nodeids := make(map[string][]*Application)
	for i := range nodes {
		if nodes[i].service_applications == nil {
			continue
		}
		fk := *nodes[i].service_applications
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "service_applications" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
